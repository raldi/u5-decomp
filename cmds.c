...

{
  ...
  if ((bVar5 != 0x20) && (bVar5 != 0x30)) {
    ...
    iVar6 = 0;
    do {
      func_0x0000bb32(*(undefined *)0x587f);
      func_0x00009990();
      if (*(char *)0x65be == 'a') {
        return;
      }
    ...
    while (local_8 != *(byte *)0x587f) {
      ...
      func_0x0000bb0e();
      uVar10 = 0x68b;
      iVar6 = func_0x0000770e(*(undefined *)0x5895,*(undefined *)0x5897,*(undefined *)0x5896);
      if (iVar6 != 0) {
        local_8 = 0xffff;
        break;
      }
...

{
  ...
  if ((*(byte *)0x5893 < 0x21) || (0x28 < *(byte *)0x5893)) {
    bVar5 = func_0x0000770e(*(undefined *)0x5895,*(undefined *)0x5897,*(undefined *)0x5896);
    iVar3 = *(int *)0x5876;
    if ((bVar5 & 0xfe) == 0x10) {
      if (((*(char *)0x5893 != '\0') && (iVar7 = func_0x0000bb9e(iVar3), iVar7 != -1)) &&
...
LAB_0000_0875:
      ...
      *(undefined *)0x587c = 0x14;
      ...
      if ((bVar5 & 0xfc) == 0x28) {
        ...
        func_0x000058d0(0x4275);
        goto LAB_0000_0875;
      }
      if ((bVar5 & 0xfc) != 0x24) {
        func_0x000058d0(0x42bf);
        return 0;
      }
      iVar7 = FUN_0000_070c();
      if (iVar7 == 0) {
      ...
      func_0x000058d0(0x427c);
      bVar4 = *(byte *)(iVar3 * 8 + 0x5c5f);
      if (bVar4 < 10) {
        func_0x000058d0(0x4282);
      }
      *(byte *)0x5c5f = bVar4;
  ...
  if ((*(byte *)0x587c < 0x20) || (0x27 < *(byte *)0x587c)) {
    ...
    if (((iVar4 != 0) || ((*(byte *)0x587c & 1) != 0)) &&
      ...
      while( true ) {
        ...
        uVar3 = func_0x0000770e(*(undefined *)0x5895,local_16,uVar8);
      ...
      iVar4 = *(int *)0x5876;
      iVar6 = func_0x0000bc6a(1,((uint)*(byte *)(iVar4 * 8 + 0x5c5d) - (uint)*(byte *)0x5897) + 5,
...
LAB_0000_0b8a:
  ...
  iVar14 = 0;
LAB_0000_0bee:
  func_0x000058d0(0x42f2,bVar13,iVar14,iVar7);
  func_0x0000842e(300,5,200,1000);
  func_0x0000bb56();
  bVar3 = false;
  bVar4 = false;
  ...
  while (((!bVar3 && (!bVar4)) && (local_18 = local_18 + -1, 0 < local_18))) {
    ...
    iVar10 = func_0x00007782(*(undefined *)0x5895,iVar7,local_14);
    if (iVar10 == 0) {
...

{
  ...
  func_0x000058d0(0x4318);
  iVar3 = func_0x00006f0e();
  if (iVar3 == -1) {
    uVar4 = 0x4320;
  }
  else {
    func_0x000058d0(iVar3 * 0x20 + 0x55a8);
    if (iVar3 == 0) {
      func_0x000058d0(0x4329);
      func_0x000058d0(0x55a8);
      uVar4 = 0x432c;
    }
    else {
      func_0x000058d0(0x4339);
      iVar5 = func_0x00006f0e();
      if (iVar5 == -1) {
        uVar4 = 0x4340;
      }
      else {
        func_0x000058d0(iVar5 * 0x20 + 0x55a8);
        if (iVar5 != 0) {
          func_0x000058d0(0x4359);
...

{
  ...
  pbVar5 = (byte *)func_0x00008482(*(undefined *)0x5897,*(undefined *)0x5896);
  bVar2 = *pbVar5;
  bVar3 = *(byte *)0x587c & 0xfc;
  if (bVar3 == 0x10) {
    func_0x000058d0(0x43a4);
    local_4 = *(char *)0x587c + -2;
LAB_0000_0f43:
    *(undefined *)0x587c = 0x1c;
LAB_0000_0ff4:
    iVar6 = func_0x00007964();
    func_0x00007af4(iVar6,*(undefined *)0x5c5f,*(undefined *)0x5895,*(undefined *)0x5897,
  ...
  if (((*(char *)0x5893 == '\x1e') || (*(char *)0x5893 == '\x1f')) || (*(char *)0x5893 == ' ')) {
    ...
    if (((iVar9 != 3) && (1 < *(byte *)0x5897)) && (*(char *)(iVar9 + 0x58c8) != -1)) {
      ...
      *(undefined *)0x58cb = local_a;
      ...
      func_0x00007af4(iVar3,0,*(undefined *)0x5895,*(byte *)0x5897 - 2,*(undefined *)0x5896,0xfc,
                      0xfc);
      iVar9 = 0x1f;
      do {
        iVar5 = iVar9;
      ...
      *(undefined *)(iVar5 + 0x659e) = 0xfc;
      func_0x000058d0(0x4425);
      func_0x00006212(2,2000,30000,1,0x28a0);
      iVar3 = iVar3 * 8;
      *(undefined *)(iVar3 + 0x5c5b) = 0x16;
      *(undefined *)(iVar3 + 0x5c5a) = 0x16;
      func_0x000050e8(3,5,0x1fc);
...

{
  ...
  func_0x000058d0(0x4450);
  func_0x00007b9c(0xf,local_12);
  iVar2 = func_0x0000af9e(local_12,*(undefined2 *)(param_3 * 2 + 0x1f4e));
  bVar5 = iVar2 != -1;
  iVar2 = 3;
  do {
    func_0x000058d0(0x4479);
    func_0x00007b9c(0xf,local_12);
    iVar3 = func_0x0000af9e(local_12,*(undefined2 *)(param_3 * 2 + 0x1f5e));
    if (iVar3 == -1) {
      bVar5 = false;
    }
    iVar2 = iVar2 + -1;
...
LAB_0000_1315:
      ...
      if (local_c == '\x1a') {
        FUN_0000_1202(iVar6 + (uint)*(byte *)0x5897,local_6 + (uint)*(byte *)0x5896,iVar5);
        return;
      }
      if ((local_6 + (uint)*(byte *)0x5896 == (uint)*(byte *)(iVar5 + 0x1eaa)) &&
        ...
        *pbVar1 = *pbVar1 ^ 0x80;
        pbVar4 = (byte *)func_0x00008482(iVar6 + (uint)*(byte *)0x5897,
...

{
  ...
  if (((*(byte *)0x587c & 0xf8) == 0x20) && (*(byte *)0x5893 < 0x80)) {
    if ((*(byte *)0x587c & 0xfc) == 0x20) {
      local_24 = func_0x000058d0(0x451a);
      pcVar1 = (char *)0x587c;
      *pcVar1 = *pcVar1 + '\x04';
    }
    else {
      local_24 = func_0x000058d0(0x4521);
      pcVar1 = (char *)0x587c;
      *pcVar1 = *pcVar1 + -4;
    }
  }
  else {
    func_0x000058d0(0x4529);
    func_0x00007b9c(0x1e,local_22);
    if (local_22[0] == '\0') {
      local_24 = func_0x000058d0(0x4531);
    }
    else {
      func_0x0000573a(10);
...

{
  ...
  if ((0x7f < *(byte *)0x5893) && (iVar9 = func_0x0000bf3a(iVar8,iVar15), iVar9 != 0)) {
    return;
  }
  pbVar10 = (byte *)func_0x00008482(iVar8,iVar15);
  bVar3 = *pbVar10;
  iVar9 = func_0x0000770e(*(undefined *)0x5895,iVar8,iVar15);
  if ((iVar9 == 0) && (iVar9 = FUN_0000_14ba(bVar3), iVar9 != 0)) {
    ...
    cVar4 = *pcVar13;
    pcVar13 = (char *)func_0x00008482(*(undefined *)0x5897,*(undefined *)0x5896);
    cVar5 = *pcVar13;
    iVar14 = func_0x0000770e(*(undefined *)0x5895,iVar12,iVar9);
    if ((iVar14 == 0) && (cVar4 == cVar6)) {
      ...
      FUN_0000_15b0(iVar2,iVar7,iVar8,iVar15,*(undefined *)0x5897,*(undefined *)0x5896,bVar3,cVar5);
    }
    local_12 = (char)iVar7;
    pcVar1 = (char *)0x5896;
...

{
  ...
  if (bVar1) {
    if ((*(byte *)0x58a1 & 0x80) == 0) {
      if (*(char *)0x58a3 != '\0') goto LAB_0000_184d;
      uVar2 = 0x4587;
    }
    else {
      uVar2 = 0x457b;
...

{
  ...
  if (iVar5 == 0) {
    func_0x000058d0(0x8f98);
    return;
  }
  func_0x000058d0(0x8fac);
  ...
  if (iVar5 == -1) {
    ...
    if (uVar3 != 0) {
      ...
      if ((iVar5 < 0) || (*(byte *)(iVar5 + 0x1cc0) != uVar3)) {
        func_0x0000573a(10);
        func_0x00007a7c();
        func_0x00007050(*(undefined2 *)0x5876);
      }
      else {
...

{
  ...
  if (*(char *)0x57af == '\0') {
    ...
    pcVar5 = (char *)func_0x00008482((uint)*(byte *)0x5897 + *(int *)0x5878,
