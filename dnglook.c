...

{
  ...
  if ((((param_2 < 0) || (0x15 < param_2)) || (param_1 < 0)) || (0x15 < param_1)) {
    ...
    func_0x00007a3a(*(undefined2 *)0x13b0);
    func_0x00007a0e(0);
  }
  return local_8;
}
...

{
  ...
  if (((bVar1 == 0xb0) || (bVar1 == 0xc0)) || (bVar1 == 0xd0)) {
    FUN_0000_097e(param_1,*(byte *)((uint)*(byte *)0x5896 +
...

{
  ...
  if (*(char *)0x5893 != '\0') {
    ...
    if ((*(byte *)0xbb17 & 1) == 0) {
      do {
        iVar1 = func_0x0000691e(*(undefined2 *)((uint)*(byte *)0x6604 * 2 + 0x25f2));
        *(int *)0xa9c0 = iVar1;
      } while (iVar1 == 0);
      do {
        iVar1 = func_0x0000691e(*(undefined2 *)0x25f2);
        *(int *)0xa9c4 = iVar1;
      } while (iVar1 == 0);
    }
    *(undefined *)0xbb17 = 1;
  ...
  if ((0 < param_1) && (((0xef < param_2 && (param_1 == 3)) || (param_1 < 3)))) {
    ...
    do {
      ...
      if (bVar2 != 0) {
        ...
        iVar7 = func_0x0000c276(*(undefined *)0x5895,*(undefined *)(local_e + -0x520c),
        ...
        if (local_14 == 2) {
          if (uVar5 == 1) {
            ...
            cVar3 = func_0x00007e02((uint)*(byte *)0x5895 * 10 + 10,1);
          }
          else {
            if (0xf < uVar5) goto LAB_0000_1385;
            cVar3 = func_0x00007e02(*(byte *)(uVar5 + 0x383f) - 1,0);
