...

{
  ...
  if (param_1 != 0) {
    ...
    *(undefined *)0x5c66 = *(undefined *)0x5895;
    if (cVar1 != -1) {
      func_0x00008a14(*(undefined2 *)0xa9c6);
    }
    *(undefined2 *)0xa9c6 = 0;
    iVar2 = FUN_0000_0252();
    if (iVar2 == 0) {
  ...
  if (*(char *)0x5c67 != -1) {
    do {
      iVar2 = func_0x000089de(*(undefined2 *)((uint)*(byte *)0x5c62 * 2 + 0x25fa));
      *(int *)0xa9c6 = iVar2;
    } while (iVar2 == 0);
  }
  return;
...

{
  ...
  FUN_0000_1be0();
  func_0x00009680(0x2ca8);
  func_0x00009680(0x2caf);
  func_0x000088a0(*(undefined2 *)0x13b0);
...
LAB_0000_0642:
    ...
    if (param_2 == 3) {
      func_0x00009680(0x2cc0);
      local_6 = 1;
    }
    else {
      if (param_2 != 4) {
        func_0x00009680(0x2d0b);
        bVar1 = *(char *)0x6603 + 2;
        goto LAB_0000_0642;
      }
      func_0x00009680(0x2ce6);
      local_6 = -1;
    }
  }
  bVar1 = *(byte *)0x6603;
...

{
  ...
  if (param_1 == 0xb) {
    uVar2 = 1;
    func_0x0000986e(0x20,1,*(undefined *)0x5888);
LAB_0000_0703:
...

{
  ...
  *(undefined *)0x6602 = 5;
  while (((param_1 == 0x61 || (param_1 == 0x69)) && (*(byte *)0x5895 < 8))) {
    func_0x00009680(0x2d6a);
    func_0x00009680(0x2d75);
...

{
  ...
  if (*(char *)0x6602 == *(char *)0x6603) goto LAB_0000_0c22;
  func_0x00009680(0x2d9b);
  cVar1 = *(char *)0x6602;
  if (cVar1 == '\0') {
    uVar2 = 0x2da6;
LAB_0000_0c03:
...
LAB_0000_0c22:
  ...
  *(undefined *)0x58a1 = 2;
  func_0x0000fa56();
  func_0x0000ddb6(0,*(undefined *)0x5c67);
  func_0x0000fa9e();
  func_0x0000fa3e(1);
  FUN_0000_0134(1);
  if (*(char *)0x5893 != '\0') {
...

{
  ...
  if ((local_4 == 0xf0) || (local_4 == 0xa0)) {
    ...
    while ((((local_4 == 0xf0 || (local_4 == 0xa0)) && (iVar2 = func_0x0000b82c(), -1 < iVar2)) &&
           (FUN_0000_0000(param_2), *(char *)0x5893 != '\0'))) {
      param_2 = *(byte *)((uint)*(byte *)0x5896 +
                          (*(uint *)0x5895 & 0xff) * 0x40 + (uint)*(byte *)0x5897 * 8 + 0x595a);
      local_4 = param_2 & 0xf0;
    }
...
LAB_0000_0dfa:
      ...
      func_0x00009680(0x2dc7);
      func_0x00009680(0x2dd3);
      pbVar1 = (byte *)((uint)*(byte *)0x5896 +
                        (*(uint *)0x5895 & 0xff) * 0x40 + (uint)*(byte *)0x5897 * 8 + 0x595a);
      *pbVar1 = *pbVar1 & 8;
LAB_0000_0dc3:
...

{
  ...
  *pbVar1 = *pbVar1 ^ 1;
  if ((*pbVar1 != 0) && (*(char *)0xa9fb != '\0')) {
    func_0x0000a06c(20000,*(undefined *)0xa9fb,1);
    func_0x0000bd66(4,0xa9fb);
  }
  return;
}
...

{
  ...
  if (param_1 <= *(byte *)(uVar2 + 0x2dcf)) {
    ...
    func_0x00009a52(0x18,0x27,*(undefined *)(iVar1 + 0x2e03),*(undefined *)(iVar1 + 0x2df7),0);
    func_0x000099c4(0);
    func_0x00009ace(1);
    func_0x00009a22(0,0);
    func_0x000094ea(0xfd);
    func_0x00009680(*(undefined2 *)((iVar1 + -1) * 2 + 0x2e10));
    func_0x000094ea(0xfd);
    func_0x00009ace(0);
    func_0x000099c4(2);
...

{
  ...
  if (*(int *)0xa9c6 == 0) {
    func_0x00009680(0x6c4e);
  }
  else {
    uVar3 = *(undefined2 *)(uVar4 * 8 + param_1 * 2 + 0x2e32);
    func_0x00008b7c(uVar4,uVar3,*(undefined2 *)(param_1 * 2 + 0x2e2a),local_6 * 3 + param_1 + -1,
                    *(undefined2 *)0xa9c6);
    func_0x00008a2c(uVar4,uVar3,0x60,local_e * 3 + param_1 + -1,*(undefined2 *)0xa9c6);
    local_4 = (char)uVar6;
...

{
  ...
  if (param_2 == 5) {
    param_2 = 0;
    func_0x0000c1de(-(param_1 * 8 + -0x14),1,0xdac,0xc80);
  }
  else {
    if (param_2 == 4) {
...

{
  ...
  if (0x9f < (int)uVar3) {
    ...
    if ((((param_1 == 1) || (param_1 == 2)) && (*(char *)0x6604 == '\x01')) &&
       ((local_6 & 0xf0) == 0xc0)) {
      cVar2 = FUN_0000_145c(param_1,uVar3 & 7,*(byte *)((uVar3 & 7) + param_1 * 5 + 0x2e8b) + 0xe,
                            0x5f);
  ...
  if ((int)uVar3 < 0xa0) {
    ...
    if (uVar4 != 0xa0) {
      if (uVar4 == 0xc0) {
        ...
        cVar2 = FUN_0000_145c(param_1,uVar3 & 7,*(byte *)((uVar3 & 7) + param_1 * 5 + 0x2e9a) + 0xe,
                              local_6);
...

{
  ...
  if (((iVar3 < 1) || (7 < iVar3)) || ((iVar3 == 6 && ((uVar2 & 7) != 0)))) {
    ...
    if (iVar3 == 5) {
      FUN_0000_1786(*(undefined *)0x2f26,param_1);
    }
  }
  if ((iVar3 < 9) &&
  ...
  *(undefined2 *)0x52c4 = 0;
  if ((*(char *)0x58a6 == '\0') && (*(char *)0x58a7 == '\0')) {
    ...
    do {
      ...
      if (iVar3 == 0) break;
      if ((iVar5 != 0) ||
         ((iVar3 = FUN_0000_10dc(*(undefined *)0x5897,*(undefined *)0x5896), iVar3 != 0xe0 &&
          (param_1 != 0)))) {
        uVar4 = (uint)*(byte *)0x6603;
        FUN_0000_1682(iVar5,0,*(byte *)(uVar4 + 0x2f2c) + local_8,*(byte *)(uVar4 + 0x2f28) + uVar6)
        ;
        uVar4 = (uint)*(byte *)0x6603;
        FUN_0000_1682(iVar5,1,local_8 - *(byte *)(uVar4 + 0x2f2c),uVar6 - *(byte *)(uVar4 + 0x2f28))
        ;
      }
      uVar6 = uVar6 + iVar1;
...

{
  ...
  {
    iVar3 = FUN_0000_1c0c(param_1,param_2 + (uint)*(byte *)0x5895);
    if (iVar3 == 0) {
      func_0x00009680(0x6c7a);
...

{
  ...
  *(undefined *)0x58a1 = 2;
  ...
  func_0x0000fae6();
  func_0x0000fa56();
  func_0x0000ddb6(0,*(undefined *)0x5c67,2);
  if (*(char *)0x58a0 == '\x05') {
    if (*(char *)0x5895 != '\0') {
      pcVar1 = (char *)0x5895;
      *pcVar1 = *pcVar1 + -1;
    ...
    if (*(char *)0x58a0 != '\x06') goto LAB_0000_1dd1;
    if (*(byte *)0x5895 < 7) {
      pcVar1 = (char *)0x5895;
      *pcVar1 = *pcVar1 + '\x01';
      goto LAB_0000_1dd1;
...

{
  ...
  bVar2 = false;
  bVar3 = false;
  uVar4 = FUN_0000_10dc(*(undefined *)0x5897,*(undefined *)0x5896);
  uVar4 = uVar4 & 0xf0;
...
LAB_0000_1ed4:
    ...
    func_0x00009680(0x6cce);
  }
  if (((bVar2) && (iVar5 = FUN_0000_1c6a(0,0xffff), iVar5 != 0)) ||
