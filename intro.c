...

{
  ...
  iVar2 = 0;
  do {
    func_0x00008b8c(0,iVar2,0x10,iVar1 + 1,*(undefined2 *)0xbb1a);
    iVar2 = iVar2 + 0x32;
    iVar1 = iVar1 + 1;
  } while (iVar1 < 4);
  return;
...

{
  ...
  *(undefined *)0x5893 = 0x40;
  do {
    iVar2 = func_0x00008dee(*(undefined2 *)0x25ea);
  } while (iVar2 == 0);
  func_0x0000fb26(0x2f30,iVar2);
  func_0x00008a62(1);
  func_0x000094fa(0xff);
  func_0x00008a62(0);
  func_0x000094fa(0xff);
  ...
  do {
    iVar3 = func_0x000089ee(*(undefined2 *)0x260c);
  } while (iVar3 == 0);
  do {
    local_6 = func_0x000089ee(*(undefined2 *)0x260e);
  } while (local_6 == 0);
  local_8 = 0;
  local_a = 0;
  do {
    ...
    if (*(byte *)(local_a + 0x30ae) != local_8) {
      ...
      do {
        local_6 = func_0x000089ee(*(undefined2 *)(local_8 * 2 + 0x260e));
      } while (local_6 == 0);
    }
    *(undefined *)0xa9be = 2;
    func_0x00008a62(1);
...
LAB_0000_01f9:
    ...
    func_0x00008b8c(0,uVar4,uVar1,*(undefined *)(local_a + 0x3098),local_6);
    if (3 < *(byte *)(local_a + 0x30f0)) {
      func_0x00008b8c(0,uVar4 + 0x37,uVar1,(uint)*(byte *)(local_a + 0x30f0) * 2 + -5,local_6);
    }
    ...
    *(uint *)0x5158 = (uint)*(byte *)(local_a + 0x3082);
    if (*(char *)(local_a + 0x30f0) == '\x03') {
      ...
      *(undefined2 *)0x5158 = 0xb4;
      ...
      iVar6 = 0x324;
      func_0x0000a3ae(*(undefined2 *)(local_a * 2 + 0x3016),2000,0xb21e,0x2f8d);
      uVar5 = 0xb21e;
    }
...

{
  ...
  func_0x000088b0(*(undefined2 *)0x13b2);
  iVar1 = iVar1 * -8;
  func_0x000088e6(199,iVar1,0xc1,8);
  iVar3 = (iVar3 + iVar2 + 2) * 8;
  func_0x000088e6(199,0x137,0xc1,iVar3);
  func_0x000088b0(*(undefined2 *)0x13b0);
  func_0x00008950(0xc0,iVar1,0xc0,8);
  func_0x00008950(0xc0,0x137,0xc0,iVar3);
...

{
  ...
  func_0x00009b0a(*(undefined2 *)0x13b2);
  ...
  *(undefined2 *)0x538e = 1;
  func_0x000088b0(*(undefined2 *)0x13b0);
  func_0x00008950(0x7f,0x138,0x7f,7);
  func_0x00008dd0(0xc0,0x138);
  func_0x00008dd0(0xc0,7);
  func_0x00008dd0(0x7f,7);
  func_0x00009b0a(*(undefined2 *)0x13b0);
  return;
}
...

{
  ...
  *(undefined *)0xa9be = 2;
  ...
  do {
    iVar1 = func_0x000089ee(*(undefined2 *)0x261e);
    *(int *)0xbb1a = iVar1;
  } while (iVar1 == 0);
  func_0x00008a62(0);
  func_0x000094fa(0xff);
  func_0x00008a62(1);
  func_0x00008b8c(0,0,0,0,*(undefined2 *)0xbb1a);
  if (param_1 != 0) {
    func_0x00008d86(100,0x13f,0,0);
    iVar1 = func_0x00009b9e();
    param_1 = (uint)(iVar1 == 0);
  }
  if (param_1 == 0) {
    func_0x0000890e(100,0x13f,0,0,0,1);
  }
  FUN_0000_0010();
  func_0x00008a24(*(undefined2 *)0xbb1a);
  if (param_1 != 0) {
    do {
      iVar1 = func_0x00008dee(0x3105);
    } while (iVar1 == 0);
    FUN_0000_20ae(iVar1);
...
{
  FUN_0000_0676(0x310c,0xc,0,param_1);
  FUN_0000_0676(0x311b,9,1,param_1);
  FUN_0000_0676(0x3130,8,2,param_1);
  FUN_0000_0676(0x3148,9,3,param_1);
  FUN_0000_0676(0x315e,0xb,4,param_1);
  FUN_0000_0676(0x316f,10,5,param_1);
  return;
}
...

{
  ...
  do {
    iVar1 = func_0x000089ee(*(undefined2 *)0x2620);
  } while (iVar1 == 0);
  func_0x00008a62(1);
  ...
  do {
    iVar2 = func_0x000089ee(*(undefined2 *)0x261e);
    *(int *)0xbb1a = iVar2;
  } while (iVar2 == 0);
  func_0x00008a62(1);
  func_0x000094fa(0xff);
  func_0x00008b8c(0,0x41,0x10,1,*(undefined2 *)0xbb1a);
  func_0x00008a24(*(undefined2 *)0xbb1a);
  FUN_0000_04e0();
  FUN_0000_06bc(4);
  do {
...

{
  ...
  *(undefined *)0xa9ce = 1;
  ...
  if (*(int *)0x52c8 == 3) {
    do {
      iVar4 = func_0x00009b42(0,0x3182);
    } while (iVar4 == 0);
    do {
      iVar4 = func_0x00009b42(1,0x318a);
    } while (iVar4 == 0);
  }
  else {
    do {
      iVar4 = func_0x00009b42(0,0x3194);
    } while (iVar4 == 0);
    do {
      iVar4 = func_0x00009b42(1,0x319b);
    } while (iVar4 == 0);
  }
  func_0x00009ade(0);
  uVar9 = 0;
  ...
  if (iVar4 == 0x4a) {
    ...
    func_0x00009690(0x31a4);
    func_0x000094fa(0xfb);
    do {
      iVar4 = func_0x00008e34(*(undefined2 *)0x25f0);
    } while (iVar4 == 0);
    *(undefined *)0x5893 = 0x41;
    ...
    do {
      iVar4 = func_0x00008dee(*(undefined2 *)0x25ee);
    } while (iVar4 == 0);
    do {
      iVar7 = func_0x00008dee(*(undefined2 *)0x25ec);
    } while (iVar7 == 0);
    func_0x0000a3ae(0,0x1060,0x55a6,0x31b5,uVar8,uVar9,iVar7);
    iVar3 = func_0x00008bb2(iVar4);
    local_a = (uint)(iVar3 == 0);
    func_0x00008a62(1);
    func_0x000088e6(199,0x13f,0x8c,0);
    func_0x00008e84(0x8c,0x6c,7,iVar4);
    func_0x0000890e(199,0x13f,0x8c,0,0,1);
    if (local_a != 0) {
...
LAB_0000_0cd0:
  do {
    ...
    if (local_a == 0x4a) {
      ...
      iVar4 = 0;
      FUN_0000_043e(0x31c1);
      FUN_0000_06bc(0);
      do {
        func_0x00009a32(0xf,0xf);
        func_0x0000ca6a();
        func_0x00009690(0x31dd);
        func_0x0000cb0e();
...
LAB_0000_0fab:
      ...
      func_0x0000a35e(3);
      func_0x0000a3ae(0,0x1060,0x55a6,0x31e6);
      if (*(char *)0x55a8 != '\0') {
        func_0x0000a3ae(0,0x200,0xb21e,0x323f);
        func_0x0000a35e(1);
        func_0x0000a418(0x100,0xb21e,0x3249);
        func_0x0000a418(0x100,0xb31e,0x3252);
        if ((*(char *)0x5893 == '\0') && (*(char *)0x5895 != '\0')) {
          func_0x0000a35e(5);
          do {
            iVar4 = func_0x000094b4(0x325c);
          } while (iVar4 == 0);
          func_0x0000a418(0x100,0xb31e,0x3266);
        }
        func_0x0000acd6(0xffff);
        *(undefined2 *)0x52be = 8;
        return;
      }
      func_0x00009690(0x31f0);
      func_0x00009690(0x3203);
      func_0x00009690(0x321e);
      func_0x00009c1a(0);
...

{
  ...
  *(undefined *)0xa9cc = uVar2;
  func_0x0000a3ae(8,0x28,0xbc88,0x3278);
  ...
  if (bVar1) {
    ...
    func_0x000094fa(0xfc);
    func_0x00009a32(5,0);
    func_0x00009690(0x3282);
    func_0x00009690(0x32b4);
    func_0x00009690(0x32d4);
    func_0x000094fa(0xfb);
    func_0x00009c1a(0);
    uVar3 = 1;
  }
    ...
    *(undefined *)0x55be = (char)((ulong)*(uint *)0xbc8a / 100);
    func_0x0000a3ae(0x140,0xb6,0xbb1c,0x32f9);
...

{
  ...
  *(undefined *)0xa9cc = uVar2;
  func_0x0000a3ae(0,0x1060,0x55a6,0x3345);
  func_0x0000a3ae(0,0x100,0xb31e,0x334e);
  func_0x00009a62(0x18,0x27,0,0,0);
  func_0x000099d4(0);
  func_0x000094fa(0xff);
...
LAB_0000_13fb:
  ...
  *(undefined2 *)0x5396 = 0;
  ...
  func_0x00009a32(0xb,0);
  func_0x000094fa(0xfc);
  func_0x00009690(0x33d9);
  func_0x00009a32(0xc,0);
  func_0x00009690(0x55a8);
  func_0x000094fa(0xfb);
  func_0x00009a32(0xd,0xc);
  func_0x00009690(0x33e1);
  func_0x0000987e(0x20,1,*(undefined *)0x55be);
  if (*(char *)0x55b1 == '\v') {
    uVar9 = 0x33ea;
  }
  else {
  ...
  func_0x00009690(0x33fa);
  func_0x0000987e(0x20,1,*(undefined *)0x55b4);
  func_0x00009a32(0x10,0x11);
  func_0x00009690(0x3401);
  func_0x0000987e(0x20,1,*(undefined *)0x55b5);
  func_0x00009a32(0x11,0x11);
  func_0x00009690(0x3408);
  func_0x0000987e(0x20,1,*(undefined *)0x55b6);
  func_0x00009a32(0x14,10);
  func_0x00009690(0x55a8);
  func_0x00009690(0x340f);
  if (*(int *)0x3304 == 0) {
    uVar9 = 0x341f;
  }
  else {
  ...
  if (*(int *)0x3304 == 0) {
    ...
    func_0x00009690(0x3439);
  }
  func_0x00009a32(8,10);
  func_0x0000987e(0x20,1,*(undefined2 *)0x55bc);
  ...
  func_0x00009a32(2,7);
  func_0x000094fa(0xfd);
  func_0x00009690(0x3452);
  func_0x000099d4(1);
  func_0x00009a32(2,7);
  func_0x000094fa(0xfd);
  func_0x00009690(0x3458);
  func_0x000094fa(0xfd);
  func_0x000099d4(2);
  func_0x000094fa(0xff);
  func_0x00009a32(0,10);
  func_0x00009690(0x345e);
  do {
    uVar9 = func_0x00009c1a(0);
  ...
  if (cVar5 == 'N') {
    do {
      func_0x00009a32(0,1);
      func_0x00009690(0x346e);
      func_0x00009c78(8,0x55a8);
    } while (*(char *)0x55a8 == '\0');
  }
  func_0x000099d4(1);
  func_0x00009a32(3,0);
  ...
  func_0x000094fa(0xfb);
  func_0x00009a32(2,7);
  func_0x00009690(0x347f);
  func_0x00009a32(5,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x3485);
  func_0x000094fa(0xfd);
  func_0x000099d4(0);
  func_0x00009a32(2,7);
  func_0x000094fa(0xfd);
  func_0x00009690(0x348a);
  func_0x00009a32(5,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x3490);
  func_0x000094fa(0xfd);
  func_0x000099d4(2);
  func_0x000094fa(0xff);
  func_0x000094fa(0xfc);
  func_0x00009690(0x3495);
  func_0x000094fa(0xfb);
  do {
    uVar9 = func_0x00009c1a(0);
    cVar5 = func_0x00009e72(uVar9);
  ...
  if (((cVar5 == 'Y') && (*(char *)0x55b1 == '\v')) || ((cVar5 == 'N' && (*(char *)0x55b1 == '\f')))
    ...
    func_0x00009690(0x34a4);
    *(undefined *)0x55b1 = 0xb;
  }
  else {
    func_0x00009690(0x34a9);
    *(undefined *)0x55b1 = 0xc;
  }
  func_0x00009a32(5,5);
  func_0x00009690(0x34b0);
  func_0x00009a32(6,3);
  func_0x000094fa(0xfd);
  func_0x00009690(0x34b5);
  func_0x000094fa(0xfd);
  func_0x00009a32(6,10);
  if (*(int *)0x3304 == 0) {
    FUN_0000_1278();
    ...
    func_0x00009690(0x34bc);
  }
  func_0x000099d4(0);
  func_0x00009a32(5,5);
  func_0x00009690(0x34c3);
  func_0x00009a32(6,3);
  func_0x000094fa(0xfd);
  func_0x00009690(0x34c8);
  func_0x000094fa(0xfd);
  func_0x000099d4(2);
  func_0x000094fa(0xff);
  func_0x00009a32(0,2);
  ...
  func_0x000099d4(0);
  func_0x00009a32(6,3);
  func_0x00009690(0x34fc);
  func_0x00009a32(8,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x3503);
  func_0x000094fa(0xfd);
  func_0x000099d4(1);
  func_0x00009a32(6,3);
  func_0x00009690(0x3508);
  func_0x00009a32(8,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x350f);
  func_0x000094fa(0xfd);
  func_0x00009a32(8,10);
  iVar8 = *(int *)0x55bc / 10;
  *(int *)0x55bc = iVar8;
  ...
  func_0x000094fa(0xff);
  func_0x000094fa(0xfc);
  func_0x00009690(0x3514);
  func_0x000094fa(0xfb);
  func_0x00009c1a(0);
  func_0x000099d4(0);
  func_0x00009a32(8,5);
  func_0x00009690(0x3532);
  func_0x00009a32(9,3);
  func_0x000094fa(0xfd);
  func_0x00009690(0x3537);
  func_0x000094fa(0xfd);
  func_0x000099d4(1);
  func_0x00009a32(8,5);
  func_0x00009690(0x353e);
  func_0x00009a32(9,3);
  func_0x000094fa(0xfd);
  func_0x00009690(0x3543);
  func_0x000094fa(0xfd);
  func_0x00009a32(9,10);
  *(undefined *)0x55be = 1;
  ...
  *(int *)0x55b8 = iVar8;
  ...
  func_0x000094fa(0xff);
  func_0x000094fa(0xfc);
  func_0x00009690(0x354a);
  func_0x000094fa(0xfb);
  func_0x00009c1a(0);
  func_0x000099d4(0);
  func_0x00009a32(9,3);
  func_0x00009690(0x3563);
  func_0x00009a32(0xb,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x356a);
  func_0x000094fa(0xfd);
  func_0x000099d4(1);
  func_0x00009a32(9,3);
  func_0x00009690(0x356f);
  func_0x00009a32(0xb,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x3576);
  func_0x000094fa(0xfd);
  func_0x00009a32(0xb,10);
  ...
  *(byte *)0x55b4 = bVar6;
  ...
  func_0x000094fa(0xff);
  func_0x00009a32(0,1);
  func_0x00009690(0x357b);
  func_0x0000987e(0x20,1,uVar2);
  func_0x00009690(0x358a);
  func_0x0000987e(0x20,1,*(undefined *)0x55b4);
  func_0x00009690(0x3595);
  func_0x00009c1a(0);
  func_0x000099d4(0);
  func_0x00009a32(0xb,5);
  func_0x00009690(0x359a);
  func_0x00009a32(0xc,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x359f);
  func_0x000094fa(0xfd);
  func_0x000099d4(1);
  func_0x00009a32(0xb,5);
  func_0x00009690(0x35a4);
  func_0x00009a32(0xc,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x35a9);
  func_0x000094fa(0xfd);
  func_0x00009a32(0xc,10);
  ...
  *(undefined *)0x55b5 = uVar7;
  ...
  func_0x000094fa(0xff);
  func_0x00009a32(0,1);
  func_0x00009690(0x35ae);
  func_0x0000987e(0x20,1,uVar2);
  func_0x00009690(0x35be);
  func_0x0000987e(0x20,1,*(undefined *)0x55b5);
  func_0x00009690(0x35c9);
  func_0x00009c1a(0);
  func_0x000099d4(0);
  func_0x00009a32(0xc,5);
  func_0x00009690(0x35ce);
  func_0x00009a32(0xd,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x35d3);
  func_0x000094fa(0xfd);
  func_0x000099d4(1);
  func_0x00009a32(0xc,5);
  func_0x00009690(0x35d8);
  func_0x00009a32(0xd,5);
  func_0x000094fa(0xfd);
  func_0x00009690(0x35dd);
  func_0x000094fa(0xfd);
  func_0x00009a32(0xd,10);
  ...
  *(undefined *)0x55b7 = uVar7;
  ...
  func_0x000094fa(0xff);
  func_0x00009a32(0,1);
  func_0x00009690(0x35e2);
  func_0x0000987e(0x20,1,uVar2);
  func_0x00009690(0x35f2);
  func_0x0000987e(0x20,1,*(undefined *)0x55b6);
  func_0x00009690(0x35fd);
  func_0x00009c1a(0);
  func_0x000099d4(0);
  func_0x00009a32(0xd,5);
  func_0x00009690(0x3602);
  func_0x000099d4(1);
  func_0x00009a32(0xd,5);
  func_0x00009690(0x3607);
  func_0x00009a32(0xf,0);
  func_0x000094fa(0xfc);
  if (*(int *)0x3304 == 0) {
    uVar9 = 0x3613;
  ...
  func_0x0000a418(0x200,0xb21e,0x3641);
  func_0x0000a418(0x1060,0x55a6,0x364b);
  func_0x0000a35e(0);
  *(char *)0x5893 = cVar4;
  *(undefined *)0xa9be = 0;
  return;
...

{
  ...
  func_0x000099d4(0);
  param_1 = param_1 * 2;
  func_0x00009a32(*(undefined2 *)(param_1 + 0x3656),3);
  func_0x00009690(*(undefined2 *)(param_1 + 0x3666));
  func_0x000099d4(1);
  func_0x00009a32(*(undefined2 *)(param_1 + 0x3656),3);
  func_0x00009690(*(undefined2 *)(param_1 + 0x3666));
  return;
...

{
  ...
  func_0x000094fa(0x7e);
  func_0x000088b0(*(undefined2 *)0x13b0);
  func_0x00008950(0x9f,0x138,0x9f,7);
  func_0x00008dd0(0xb8,0x138);
...

{
  ...
  func_0x00009b0a(*(undefined2 *)0x13b2);
  func_0x00009a32(0,0);
  func_0x00009690(0x3676);
  func_0x0000ca6a();
  func_0x00009b0a(*(undefined2 *)0x13b0);
  func_0x00009690(0x6d3a);
  func_0x00009b0a(*(undefined2 *)0x13b2);
  func_0x0000cb0e();
  func_0x00009690(0x367a);
  func_0x000094fa(0x7c);
