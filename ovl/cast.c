...

{
  ...
  cVar1 = *(char *)(param_1 * 8 + -0x45e9);
  if (((cVar1 == '/') || (cVar1 == '\x0e')) || (cVar1 == '\x0f')) {
    uVar2 = 1;
  }
  else {
    uVar2 = 0;
...

{
  ...
  *(undefined *)0x589d = (undefined)param_1;
  func_0x000102fa(param_1,*(undefined *)0x589e);
  return;
}
...

{
  ...
  if (*(byte *)0x5893 < 0x80) {
    ...
    *(undefined *)0x589d = *(undefined *)(param_1 + 0x4592);
    func_0x000102fa(*(undefined *)0x589d,*(undefined *)0x589e);
  }
  return 0xffff;
}
...

{
  ...
  iVar3 = func_0x00010312();
  if (iVar3 == 0) {
    return 0xffff;
  }
  func_0x00010336(1);
  pbVar4 = (byte *)ultima_1000_4402(*(undefined2 *)0x5878,*(undefined2 *)0x5876);
  bVar2 = *pbVar4;
  if (bVar2 == 0x9d) {
LAB_1000_4425:
    *pbVar4 = 0x44;
    ultima_1000_1850(0x459a);
    pbVar1 = (byte *)0x24e6;
    *pbVar1 = *pbVar1 | 2;
    ultima_1000_5910();
    ...
    if (bVar2 < 0x9e) {
      if ((bVar2 == 0x5b) || ((0x8f < bVar2 && (bVar2 < 0x94)))) goto LAB_1000_4425;
    }
    else if ((0xa4 < bVar2) &&
            ((bVar2 < 0xa7 ||
...

{
  ...
  if ((*(byte *)0x5893 < 0x21) || (0x7f < *(byte *)0x5893)) {
    iVar7 = func_0x00010312();
    if (iVar7 == 0) {
      local_8 = 0xffff;
    }
    else {
      local_8 = 0;
      pcVar8 = (char *)ultima_1000_4402(*(undefined2 *)0x5878,*(undefined2 *)0x5876);
      cVar4 = *pcVar8;
    ...
    if ((bVar3 & 0xf0) == 0x40) {
      if ((bVar3 & 1) != 0) {
        ultima_1000_1850(0x45a1);
      }
      *local_4 = *local_4 & 8 | 0x70;
      ultima_1000_1850(0x45ac);
      local_8 = 0xffff;
    }
    else {
      local_8 = 0;
...

{
  ...
  while ((iVar3 = func_0x000100c6(), iVar3 == 0 ||
         (iVar3 = func_0x0001ffa6(*(undefined2 *)0x5878,*(undefined2 *)0x5876,0x90), iVar3 == 0))) {
    local_c = local_c + 1;
    if (7 < local_c) {
      return 0;
    }
  }
  iVar3 = ultima_1000_6506(*(undefined *)0x5895,*(undefined2 *)0x5878,*(undefined2 *)0x5876,0,local_4
                         );
  if (iVar3 < 0) {
    return 0;
  }
  ...
  *(undefined *)(iVar4 + 0x5c5b) = 0x16;
  ultima_1000_1068(*(undefined2 *)0x5878,*(undefined2 *)0x5876,local_4 * 4 + 0x140);
  ...
  if (*(byte *)0x5893 < 0x80) {
    ...
    if (iVar5 == 0) {
      ...
      for (uVar9 = (uint)*(byte *)0x5878;
        ...
        pcVar6 = (char *)ultima_1000_4402(uVar9,uVar7);
        if (*pcVar6 == '\x05') {
          local_c = -1;
    ...
    if ((*(byte *)0x58a1 & 2) == 0) {
      ...
      do {
        iVar4 = func_0x000100c6();
        if ((iVar4 != 0) &&
           (iVar4 = func_0x0001ffa6(*(undefined2 *)0x5878,*(undefined2 *)0x5876,uVar1), iVar4 != 0))
        {
...

{
  ...
  local_6 = 0;
  iVar3 = 0;
  while ((iVar2 = func_0x000100c6(), iVar2 == 0 ||
         (iVar2 = func_0x0001ffa6(*(undefined2 *)0x5878,*(undefined2 *)0x5876,0xbc), iVar2 == 0))) {
    iVar3 = iVar3 + 1;
    if (7 < iVar3) {
LAB_141b_07ed:
      if (local_6 != 0) {
        ...
        iVar3 = 0;
        do {
          iVar2 = ultima_1000_6506(*(undefined *)0x5895,*(undefined2 *)0x5878,*(undefined2 *)0x5876,0
                                  ,0x1f);
          if (iVar2 < 0) {
            return local_6;
          }
...

{
  ...
  if (iVar3 == 0) {
    ...
    func_0x00010336(5);
    pbVar5 = (byte *)ultima_1000_4402(*(undefined2 *)0x5878,*(undefined2 *)0x5876);
    uVar4 = 0;
    bVar2 = *pbVar5;
    if (0xb7 < bVar2) {
      if (bVar2 < 0xba) {
...

{
  ...
  do {
    if (*pcVar5 != '\0') {
      iVar1 = ultima_1000_5646(iVar4);
      if (iVar1 != 0) {
        iVar1 = ultima_1000_3abe();
        iVar2 = func_0x000100f6(0xfffe,iVar4);
        if (iVar2 <= iVar1) {
          ultima_1000_3564(iVar4);
          uVar3 = ultima_1000_2092(0x14,1,iVar4,param_1 * 0x20 + 0x55bc);
          uVar3 = func_0x0001ff5e(uVar3);
          ultima_1000_3f14(9999,uVar3);
          func_0x0001ffe2(*(undefined *)0x589e,iVar4);
        }
      }
    }
    pcVar5 = pcVar5 + 8;
...

{
  ...
  ultima_1000_1850(0x45bb);
  iVar2 = func_0x00010372(0xf,*(undefined *)0x589e);
  if (iVar2 == 0) {
LAB_1000_4b6f:
    uVar3 = 0xffff;
  }
    ...
    func_0x00010336(6);
    pbVar4 = (byte *)ultima_1000_4402(*(undefined *)0x589a,*(undefined *)0x5899);
    if ((*pbVar4 & 0xfe) != 0x84) {
      iVar2 = func_0x0001037e(*(undefined *)0x589a,*(undefined *)0x5899);
      if (-1 < iVar2) {
        iVar5 = cast_141b_0000(iVar2);
        if (iVar5 == 0) {
          iVar5 = ultima_1000_5646(iVar2);
          if (iVar5 != 0) {
            iVar5 = func_0x0001034e(0,iVar2,*(undefined *)0x589e);
            if (iVar5 == 0) {
              iVar5 = iVar2 * 8;
              ...
              *pbVar1 = *pbVar1 ^ 1;
              ...
              func_0x0001ffca(iVar2);
              ultima_1000_1850(0x45c6);
              goto LAB_1000_4b6f;
            }
          }
        }
...

{
  ...
  ultima_1000_1850(0x45d1);
  iVar3 = func_0x00010372(0xf,*(undefined *)0x589e);
  if (iVar3 == 0) {
    uVar4 = 0xffff;
  }
  else {
    ...
    if (((-1 < iVar3) && (iVar5 = cast_141b_0000(iVar3), iVar5 == 0)) &&
      ...
      ultima_1000_6506(*(undefined *)0x5895,uVar2,uVar1,0,0x14);
      return 1;
    }
    uVar4 = 0;
  }
      ...
      if (iVar4 != 0xff) {
        ...
        if (iVar3 != 0xff) {
          ...
          *(undefined2 *)(iVar4 + 0x5c60) = *(undefined2 *)(iVar2 + 0x5c60);
          do {
            iVar2 = func_0x000100c6();
            if ((iVar2 == 0) ||
               (iVar2 = func_0x0001ffa6(*(undefined2 *)0x5878,*(undefined2 *)0x5876,0x1c),
               iVar2 == 0)) {
              local_8 = 0;
            }
            else {
...

{
  ...
  if ((*(byte *)0x587c & 0xf0) != 0x20) {
    ...
    if ((0x30 < bVar1) && (bVar1 < 0x39)) {
      uVar3 = 8;
      func_0x00010336(8);
      iVar2 = ultima_1000_47f4(uVar3 & 0xff);
      if (iVar2 != 0) {
        return 0xffff;
      }
    }
...

{
  ...
  do {
    if (*pcVar1 == -4) {
      ultima_1000_1850(0x45f2);
      ultima_1000_2192(2,1000,28000,1,0x2648);
      local_6 = 0;
      break;
    }
    pcVar1 = pcVar1 + 8;
...

{
  ...
  *(undefined *)0x5890 = 1;
  ...
  ultima_1000_1850(0x4603,iVar6,uVar7);
  uVar3 = func_0x000102be();
  if (uVar3 == 0xffff) {
    uVar7 = 0x4611;
LAB_1000_4fa7:
    iVar2 = ultima_1000_1850(uVar7);
    return iVar2;
  }
  if (uVar3 == 0xfffe) {
    uVar7 = 0x4618;
  ...
  *(char *)0x588f = (char)uVar4;
  if (*(char *)0x5893 == '\0') {
    ...
    if (((*(char *)0x5893 == '\x12') && (*(char *)0x57b4 == '\0')) || (*(char *)0x5893 == '\x1d')) {
      ultima_1000_1850(0x4624);
      iVar2 = ultima_1000_2192(2,1000,28000,1,0x2648);
      return iVar2;
    }
    if (*(byte *)0x5893 < 0x21) {
  ...
  if (iVar6 == 0) {
    ultima_1000_1850(0x462f);
    iVar2 = ultima_1000_43ae(0x32,1,2000,800);
    return iVar2;
  }
  ...
  if (*(byte *)(iVar2 * 0x20 + 0x55b7) < uVar4) {
    ...
    *pcVar1 = *pcVar1 - (char)uVar4;
    ...
    if (uVar4 <= *(byte *)(iVar2 * 0x20 + 0x55be)) {
      if (uVar3 < 0x30) {
                    // WARNING: Could not emulate address calculation at 0x000150ca
...
LAB_141b_11a6:
  if (iVar6 == 1) {
    ultima_1000_1850(0x4656);
    return 1;
  }
  if (iVar6 != 0) {
    return 1;
  }
  ultima_1000_1850(0x4660);
...

{
  ...
  *pcVar1 = *pcVar1 + -1;
  ultima_1000_1850(0x466a);
  if (7 < param_1) {
    return 1;
  }
                    // WARNING: Could not emulate address calculation at 0x000153b5
                    // WARNING: Treating indirect jump as call
...

{
  ...
  *pcVar1 = *pcVar1 + -1;
  ultima_1000_1850(0x4706);
  if (*(byte *)0x5893 < 0x80) {
    uVar3 = func_0x0001035a();
  }
  else {
    uVar3 = (uint)*(byte *)((uint)*(byte *)0x589e * 8 + -0x45e9);
  }
  if (-1 < (int)uVar3) {
    func_0x00010336(param_1);
    iVar2 = ultima_1000_2092(0xf,0);
    if (iVar2 == 0) {
      param_1 = 4;
    }
    else if (iVar2 == 1) {
      param_1 = ultima_1000_2092(7,0);
    }
    if (param_1 < 8) {
                    // WARNING: Could not emulate address calculation at 0x0001558b
                    // WARNING: Treating indirect jump as call
...

{
  ...
  bVar1 = *pbVar2;
  ultima_1000_1850(0x4768);
  if ((*(byte *)0x5893 < 0x21) &&
     (((bVar1 == 0x2c || (bVar1 == 0x2d)) || ((3 < bVar1 && (bVar1 < 0xb)))))) {
    ultima_1000_1850(0x4773);
...
LAB_1000_5789:
  ...
  iVar4 = 2000;
  do {
    ultima_1000_2192(0,iVar4,200,1,0xa50);
    iVar4 = iVar4 + 0x32;
  } while (iVar4 < 25000);
  iVar4 = 25000;
  do {
  ...
  if ((((*(char *)(param_1 + 0x4882) != *(char *)0x5896) ||
    ...
    ultima_1000_1850(0x47f0);
    ultima_1000_43ae(0x32,1,2000,800);
    return;
  }
  ultima_1000_3ae6(7);
  ultima_1000_1850(0x47fe);
  if (param_1 == 0) {
    uVar3 = 0x4822;
LAB_1000_5849:
    ultima_1000_1850(uVar3);
  ...
  ultima_1000_3ae6(3);
  iVar4 = *(byte *)0x5897 - 1;
  iVar2 = ultima_1000_368e(*(undefined *)0x5895,iVar4,*(undefined *)0x5896);
  if (iVar2 != 0xfc) {
    return;
  }
  ...
  uVar3 = func_0x0001fd4e(*(undefined2 *)0x5876);
  func_0x0001fd42(uVar3);
  uVar3 = 7;
  iVar2 = 7;
  do {
    ultima_1000_3522(*(byte *)0x5897 - 1,*(undefined *)0x5896,iVar4,uVar3);
    iVar2 = iVar2 + -1;
  } while (iVar2 != 0);
  ...
  *puVar1 = *puVar1 | (uint)*(byte *)(param_1 + 0x4892);
  ...
  if (param_1 == 0) {
    ...
    if (param_1 != 2) goto LAB_141b_1752;
    uVar3 = 0x486a;
  }
  ultima_1000_1850(uVar3);
LAB_141b_1752:
  ultima_1000_1850(0x4874);
  ultima_1000_4368();
  return;
}
...

{
  ...
  local_c = 1;
  func_0x00010396();
  iVar1 = func_0x000101c2(0xff,0xb9ee,0x26,0xffff);
  if (iVar1 == -1) {
    ultima_1000_1850(0x489f);
  }
  else {
    ultima_1000_1850(0x48b1);
    func_0x0001d12c();
    ultima_1000_1b94(1);
    ultima_1000_4e50(0x48b8);
    func_0x0001038a(8);
    iVar1 = func_0x000103a2(0x55,0xff,iVar1);
    func_0x0001cfda();
    ultima_1000_4e20();
    ultima_1000_4f3c();
    ultima_1000_2900();
    if (-1 < iVar1) {
      if (iVar1 < 8) {
        ...
        if (iVar1 - 0x10U < 0x16) {
                    // WARNING: Could not emulate address calculation at 0x00015a0d
                    // WARNING: Treating indirect jump as call
...

{
  ...
  if ((((param_3 < 8) || (0xb6 < param_3)) || ((int)param_2 < 8)) || (0xb6 < (int)param_2)) {
    ...
    *(undefined2 *)0x5876 = 0xffff;
    ...
    ultima_1000_0a70(param_1);
    ultima_1000_0c64(param_2,param_3);
    ultima_1000_0c64(param_2,param_3 + 1);
    uVar1 = ultima_1000_2092(10000,100);
    ultima_1000_22e2(uVar1);
    if ((param_2 & 1) == 0) {
      return 1;
    }
    ultima_1000_3fb4(param_2,param_3);
    if ((-1 < *(int *)0x5876) && (-1 < *(int *)0x5878)) {
      uVar1 = ultima_1000_3f6e(*(undefined2 *)0x5878,*(undefined2 *)0x5876);
      return uVar1;
    }
  }
  return 0;
...
LAB_1000_6068:
                ...
                *piVar2 = *piVar2 + 1;
                ...
                piVar7 = piVar10;
                if (param_1 == 3) goto LAB_1000_604e;
                if (param_1 == 4) goto LAB_1000_6068;
              }
              if (*piVar6 < 1) {
                if (local_5c < 10) {
                  iVar4 = -1;
...
LAB_1000_60b6:
                ...
                else if (param_1 == 4) goto LAB_1000_60b6;
                piVar2 = piVar6;
...

{
  ...
  ultima_1000_223c(700,local_10a,800);
        ...
        if (((((uint)*(byte *)(local_114 + 6) == *(uint *)((int)register0x00000010 + -0x80)) &&
          ...
          *pbVar1 = *pbVar1 | 0x80;
          if (param_2 == 1) {
            ...
            ultima_1000_3564(iVar8);
            ultima_1000_68ae(iVar8);
          }
          else if (param_2 == 2) {
            iVar6 = func_0x000100f6(0xfffe,iVar8);
            iVar7 = ultima_1000_3abe();
            if (iVar7 < iVar6) break;
            ultima_1000_3564(iVar8);
            func_0x0001011a(param_3,iVar8);
          }
          else {
            iVar6 = iVar8;
            if (param_2 == 3) {
              ultima_1000_3564(iVar8);
              iVar7 = iVar3 + 0x55bc;
              uVar4 = ultima_1000_3aae(0x1e,iVar8,iVar7);
            }
            else {
            ...
            uVar4 = func_0x0001ff5e(uVar4,iVar6,iVar7);
            ultima_1000_3f14(9999,uVar4);
          }
          func_0x0001ffe2(param_3,iVar8);
          break;
        }
