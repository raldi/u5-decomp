...

{
  ...
  *(undefined *)0x589e = 0xff;
  ...
  ultima_1000_256e(local_1e * 0x1600 + (param_1 & 0xf) * 0x160,0x160,0xad14,0x2c6a);
...

{
  ...
  ultima_1000_1b94(0);
  uVar4 = 0xc;
  ultima_1000_1bf2(0,0xc);
  iVar3 = *(byte *)0x5895 + 1;
  ultima_1000_1a3e(0x20,1,iVar3,uVar4,iVar3);
  ultima_1000_1bf2(0x17,0xc);
  cVar1 = *(char *)0x6603;
  if (cVar1 == '\0') {
    uVar4 = 0x2c7c;
  }
...

{
  ...
  do {
    bVar1 = *(byte *)0x5895;
    local_a = ultima_1000_2092(0x3f,0);
      ...
      if (((int)local_a % 8 != (uint)*(byte *)0x5896) && (uVar4 != *(byte *)0x5897)) {
        ...
        *(undefined *)0x5c65 = local_6;
        if (((*(char *)0x5c67 == '\x16') || (*(char *)0x5c67 == '\x18')) &&
           (iVar3 = ultima_1000_2092(99,0), 0x30 < iVar3)) {
...

{
  ...
  ultima_1000_0a70(*(undefined2 *)0x13b2,uVar1);
  ultima_1000_0aa6(7,0x98,0,0x28);
  ...
  ultima_1000_1b94(0);
  ultima_1000_1bf2(0,10);
  ultima_1000_4c2a();
  ultima_1000_1850(0x2c9a);
  ultima_1000_4cce();
  ultima_1000_1bf2(0x17,6);
  ultima_1000_4c2a();
  ultima_1000_1850(0x2c9d);
  ultima_1000_4cce();
...

{
  ...
  do {
    ...
    if (iVar2 == 0) {
      ...
      ultima_1000_0ace(0xb2,uVar1,0xe,uVar4,0,1);
      if (*(char *)0x6604 != '\x01') {
        iVar3 = 0;
      }
      dungeon_1040_1020();
...

{
  ...
  dungeon_1040_1be0();
  ultima_1000_1850(0x2ca8);
  ultima_1000_1850(0x2caf);
  ultima_1000_0a70(*(undefined2 *)0x13b0);
  ultima_1000_0b86(0xb7,0xb7,8,8);
  ultima_1000_20fa(1);
  ultima_1000_0b86(0xb7,0xb7,8,8);
  ultima_1000_223c(20000,500,1);
  if (param_1 < 1) {
...
LAB_1040_0642:
    ...
    if (param_2 == 3) {
      ultima_1000_1850(0x2cc0);
      local_6 = 1;
    }
    else {
      if (param_2 != 4) {
        ultima_1000_1850(0x2d0b);
        bVar1 = *(char *)0x6603 + 2;
        goto LAB_1040_0642;
      }
      ultima_1000_1850(0x2ce6);
      local_6 = -1;
    }
  }
  bVar1 = *(byte *)0x6603;
...

{
  ...
  if (param_1 == 0xb) {
    uVar2 = 1;
    ultima_1000_1a3e(0x20,1,*(undefined *)0x5888);
LAB_1040_0703:
    ultima_1000_16ba(10,uVar2);
    return 1;
  }
  if ((int)param_1 < 0xc) {
    if (0 < (int)param_1) {
      ...
      if (param_1 == 5) {
        ...
        ultima_1000_1850(0x2d3b);
        return 1;
      }
    }
LAB_1040_07bc:
    if ((param_1 < 0x30) || (0x39 < param_1)) {
      local_4 = ultima_1000_3178(param_1);
    }
    else {
      ultima_1000_4080(param_1);
      local_4 = 0;
    }
  }
  else {
    ...
    if (*(char *)0x5c67 != '\x1b') {
      ...
      do {
        ...
        if ((((bVar1 != 0x60) && (bVar1 != 0x80)) && (bVar1 < 0xa0)) &&
           (((uVar7 != bVar3 || (uVar8 != bVar2)) || (iVar6 = ultima_1000_2092(7,0), iVar6 == 1)))) {
          local_e = 900;
          break;
        }
        local_c = local_c + 1;
...

{
  ...
  *(undefined *)0x6602 = 5;
  while (((param_1 == 0x61 || (param_1 == 0x69)) && (*(byte *)0x5895 < 8))) {
    ultima_1000_1850(0x2d6a);
    ultima_1000_1850(0x2d75);
...
LAB_1040_0c22:
  ...
  *(undefined *)0x58a1 = 2;
  func_0x0001fe56();
  ultima_1000_5f86(0,*(undefined *)0x5c67);
  func_0x0001fe9e();
  func_0x0001fe3e(1);
  dungeon_1040_0134(1);
  if (*(char *)0x5893 != '\0') {
...

{
  ...
  if (*(char *)0x585b != '\0') {
    ...
    uVar4 = 0;
    do {
      if ((*pcVar3 == 'S') && (iVar2 = ultima_1000_2092(0x3f,0), iVar2 < 4)) {
        *pcVar3 = 'G';
        local_8 = local_8 + '\x01';
      }
      pcVar3 = pcVar3 + 0x20;
  ...
  if ((local_4 == 0xf0) || (local_4 == 0xa0)) {
    func_0x0001fe32();
    while ((((local_4 == 0xf0 || (local_4 == 0xa0)) && (iVar2 = ultima_1000_39fc(), -1 < iVar2)) &&
...
LAB_1040_0dfa:
      ...
      ultima_1000_1850(0x2dc7);
      ultima_1000_1850(0x2dd3);
      pbVar1 = (byte *)((uint)*(byte *)0x5896 +
                        (*(uint *)0x5895 & 0xff) * 0x40 + (uint)*(byte *)0x5897 * 8 + 0x595a);
      *pbVar1 = *pbVar1 & 8;
LAB_1040_0dc3:
  ...
  *(undefined *)0xbb17 = 2;
  ...
  do {
    do {
      ...
      iVar6 = 1;
      iVar5 = ultima_1000_39fc();
      if (iVar5 == 1) {
        ultima_1000_16ba(10);
        ultima_1000_4c2a();
        ultima_1000_1850(0x2ddd);
      }
      if (-1 >= iVar5) {
        iVar6 = 0;
      }
...

{
  ...
  *pbVar1 = *pbVar1 ^ 1;
  if ((*pbVar1 != 0) && (*(char *)0xa9fb != '\0')) {
    ultima_1000_223c(20000,*(undefined *)0xa9fb,1);
    ultima_1000_3f36(4,0xa9fb);
  }
  return;
}
...

{
  ...
  if (param_1 <= *(byte *)(uVar2 + 0x2dcf)) {
    ...
    ultima_1000_1c22(0x18,0x27,*(undefined *)(iVar1 + 0x2e03),*(undefined *)(iVar1 + 0x2df7),0);
    ultima_1000_1b94(0);
    ultima_1000_1c9e(1);
    ultima_1000_1bf2(0,0);
    ultima_1000_16ba(0xfd);
    ultima_1000_1850(*(undefined2 *)((iVar1 + -1) * 2 + 0x2e10));
    ultima_1000_16ba(0xfd);
    ultima_1000_1c9e(0);
    ultima_1000_1b94(2);
...

{
  ...
  if (*(int *)0xa9c6 == 0) {
    ultima_1000_1850(0x6c4e);
  }
  else {
    uVar3 = *(undefined2 *)(uVar4 * 8 + param_1 * 2 + 0x2e32);
    ultima_1000_0d4c(uVar4,uVar3,*(undefined2 *)(param_1 * 2 + 0x2e2a),local_6 * 3 + param_1 + -1,
                    *(undefined2 *)0xa9c6);
    ultima_1000_0bfc(uVar4,uVar3,0x60,local_e * 3 + param_1 + -1,*(undefined2 *)0xa9c6);
    local_4 = (char)uVar6;
...
LAB_1040_12be:
  if (0 < *(int *)(param_2 * 2 + 0x2e52)) {
    ...
    do {
      iVar5 = ultima_1000_2092(iVar3 - iVar2,uVar4);
      uVar6 = ultima_1000_2092(iVar3,uVar4);
      ultima_1000_0c9c(iVar2 + iVar5,uVar6,iVar5);
      iVar7 = iVar7 + -1;
    } while (iVar7 != 0);
  }
...

{
  ...
  if ((int)param_3 < 0x1f) {
    ...
    if (param_1 == 0) {
      ...
      param_2 = 0;
LAB_1040_1452:
      ultima_1000_0d4c(param_2,uVar2,local_8,param_3,uVar3);
      return;
    }
    uVar3 = *(undefined2 *)0xa9c0;
    uVar2 = 0xe;
  ...
  ultima_1000_0bfc(param_2,uVar2,local_8,param_3,uVar3);
  return;
}
...

{
  ...
  if (param_2 == 5) {
    param_2 = 0;
    ultima_1000_43ae(-(param_1 * 8 + -0x14),1,0xdac,0xc80);
  }
  else {
    if (param_2 == 4) {
    ...
    ultima_1000_0a70(uVar1);
    ultima_1000_0c9c(param_4 + 1,param_3,param_4 + -1);
    ultima_1000_0cf2(param_3 + 1,param_3 + -1,param_4);
    if (param_2 < 4) {
      ultima_1000_0a70(*(int *)0x13b2 + 8);
      ultima_1000_0c64(param_3,param_4);
    }
    if ((param_2 != 0) || (iVar2 = ultima_1000_2092(0x40,0), iVar2 < 4)) {
      param_2 = param_2 + 1;
    }
  }
  return param_2;
    ...
    if (param_1 == 1) {
      if (((local_6 & 0xf0) == 0xb0) && ((uVar3 & 0xf) != 0)) {
        dungeon_1040_104c(uVar3 & 0xf);
              ...
              (((local_6 & 0xf0) == 0xc0 && (iVar4 = ultima_1000_2092(0x40,0), iVar4 < 4)))) {
        ultima_1000_0a70(*(int *)0x13ae + 8);
        ultima_1000_0c9c(0x5d,0x57,0x5c);
        ultima_1000_0c9c(0x5d,0x58,0x5b);
        ultima_1000_0c9c(0x62,0x57,0x61);
        ultima_1000_0c9c(99,0x58,0x61);
      }
    }
  ...
  if (param_2 == 0) {
    ...
    if (param_2 == 1) {
      ...
      do {
        iVar3 = *pbVar6 + 0x60;
        uVar2 = (uint)*local_c;
        ultima_1000_0c64(iVar3,uVar2 + 0x48);
        ultima_1000_0c64(iVar3,0x76 - uVar2);
        local_c = local_c + 2;
        pbVar6 = pbVar6 + 2;
    ...
    if (param_2 == 2) {
      ...
      do {
        iVar3 = *pbVar6 + 0x60;
        uVar2 = (uint)*local_10;
        ultima_1000_0c64(iVar3,uVar2 + 0x50);
        ultima_1000_0c64(iVar3,0x6e - uVar2);
        local_10 = local_10 + 2;
        pbVar6 = pbVar6 + 2;
    ...
    ultima_1000_0c64(uVar4,uVar2 + 0x58);
    iVar3 = 0x66 - uVar2;
  }
  ultima_1000_0c64(uVar4,iVar3);
  return;
}
...

{
  ...
  *(undefined *)0x545e = 0xff;
  ultima_1000_0c22(1);
  ultima_1000_0a70(0);
  ultima_1000_0aa6(0xb2,0xaf,0xe,0x60);
  ultima_1000_0c3c(0xb7,0x98,0x2a,0x28);
  *(undefined2 *)0x52c4 = 0;
...

{
  ultima_1000_2900();
  dungeon_1040_1a90();
  ultima_1000_0ace(0xb2,0xaf,0xe,0x10,0);
  dungeon_1040_1020();
  dungeon_1040_01d2();
  return;
}
...

{
  ...
  *(undefined *)0x58a1 = 2;
  ...
  func_0x0001fee6();
  func_0x0001fe56();
  ultima_1000_5f86(0,*(undefined *)0x5c67,2);
  if (*(char *)0x58a0 == '\x05') {
    if (*(char *)0x5895 != '\0') {
      pcVar1 = (char *)0x5895;
      *pcVar1 = *pcVar1 + -1;
