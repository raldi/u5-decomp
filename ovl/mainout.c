...
void __cdecl16near FUN_1040_0000(void)
...
void __cdecl16near FUN_1040_007a(void)
...
undefined2 FUN_1040_00da(int param_1)
...
int FUN_1040_01fe(int param_1,int param_2)

{
  ...
  if ((*(byte *)0x587c & 0xfc) == 0x24) {
    func_0x00019a80(0x2982);
  }
  bVar3 = true;
  iVar4 = func_0x0001b8be(*(undefined *)0x5895,param_1 + (uint)*(byte *)0x5897,
...
LAB_1040_0283:
  ...
  if ((bVar3) && (iVar4 = func_0x0001ae7c(cVar2,*(undefined *)0x587c), iVar4 != 0)) {
    iVar4 = 1;
  }
  else {
    iVar4 = 0;
  ...
  if (*(char *)0x5955 == '\0') {
    ...
    func_0x00019a80(0x29ae);
    if (cVar2 == '/') {
      func_0x00019a80(0x29b8);
      func_0x0001acd8();
    }
    else {
...
LAB_1040_02df:
  if (cVar2 == 'G') {
    func_0x00019a80(0x29a5);
    pcVar1 = (char *)0x587c;
    *pcVar1 = *pcVar1 + '\x04';
  }
  else {
    func_0x0001a46c(300,2000,100);
    FUN_1040_109e();
  }
  *(undefined *)0x5955 = 0;
  *(undefined *)0x5956 = 1;
...
void FUN_1040_0354(undefined2 param_1,undefined2 param_2)
...
void __cdecl16near FUN_1040_03e0(void)

{
  ...
  pbVar2 = (byte *)func_0x0001c632(*(undefined *)0x5897,*(undefined *)0x5896);
  bVar1 = *pbVar2;
  if (bVar1 == 5) {
LAB_1040_0406:
    local_6 = 0;
...
LAB_1040_041f:
  if (local_6 == 1) {
    ...
    FUN_1040_007a();
    if (iVar3 + iVar4 == 0) {
      func_0x00019a80(0x29cf);
    }
    uVar5 = 4;
  }
  func_0x0001d1ac(uVar5);
  return;
}



int FUN_1040_0490(int param_1,uint param_2)

{
  ...
  if (param_2 == 1) {
    uVar4 = 0xffff;
    iVar1 = FUN_1040_00da(3,0,0xffff);
    if (iVar1 != 0) {
      return iVar1;
    }
...
LAB_1040_050e:
  iVar1 = FUN_1040_01fe(uVar3,uVar4);
  if ((param_1 == 0) && (iVar1 != 0)) {
    if ((*(byte *)0x587c & 0xfe) == 0x12) {
      func_0x0001c56e();
    }
    FUN_1040_0354(uVar3,uVar4);
    FUN_1040_03e0();
  }
  return iVar1;
}
...
uint __cdecl16near FUN_1040_0598(void)

{
  ...
  if ((*(byte *)0xabc7 & 0xfc) == 0xd4) {
    ...
    *(undefined *)0x5956 = 1;
    while (*(char *)0x5955 != '\0') {
      uVar4 = func_0x00019d68();
      local_6 = func_0x0001a262(uVar4);
...
undefined2 __cdecl16near FUN_1040_06ec(void)

{
  ...
  func_0x00019a80(0x29fe);
  pbVar1 = (byte *)func_0x0001c632(*(undefined *)0x5897,*(undefined *)0x5896);
  if ((*pbVar1 < 4) && (((*(byte *)0x587c & 0xfc) == 0x28 || ((*(byte *)0x587c & 0xfe) == 0x14)))) {
    func_0x00019a80(0x2a06);
  }
  else {
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = iVar4;
      uVar5 = func_0x0001b8be(*(undefined *)0x5895,iVar4,iVar3);
      uVar5 = uVar5 & 0xfc;
      if ((uVar5 == 0x2c) || (((uVar5 != 0xb4 && (uVar5 != 0xe8)) && (0x3f < uVar5)))) {
        func_0x0001e380(*(undefined2 *)0x5876);
      }
      else {
        func_0x00019a80(0x2a10,iVar4,iVar3,uVar5,iVar2);
      }
    }
  }
  return 0;
...
undefined2 FUN_1040_0790(undefined2 param_1)

{
  ...
  if (iVar3 < 0x28) {
    if (*(char *)0x587c != '\x1c') {
      uVar1 = func_0x00019a80(0x2a24);
      return uVar1;
    }
    if (iVar3 == 0x27) {
      if ((*(byte *)0x58c8 & *(byte *)0x58c9 & *(byte *)0x58ca) < 0x80) {
        func_0x00019a80(0x2a2f);
        iVar3 = func_0x0001bb14();
        *(undefined *)(iVar3 * 8 + 0x5c5a) = 0xfc;
        uVar1 = func_0x0001e380(iVar3,iVar3);
        return uVar1;
      }
    }
    else {
      func_0x00019a80(0x2a47);
      func_0x000198ea(0xfc);
      func_0x00019a80(*(undefined2 *)(iVar3 * 2 + 0x1e3a));
    ...
    if (*(char *)0xa9bd != '\x01') {
      func_0x0001a74e(1);
      do {
        iVar2 = func_0x000198a4(0x2a4a);
      } while (iVar2 == 0);
    }
    uVar1 = func_0x0001fc52();
    func_0x0001a808(0x100,0x5c5a,uVar1);
    func_0x0001a74e(2);
    func_0x0001a79e(iVar3 * 0x200 + -0x4000,0x200,0x595a,0x2a53);
    local_4 = (char)iVar3;
...
undefined2 __cdecl16near FUN_1040_08de(void)

{
  ...
  func_0x00019a80(0x2a6f);
  pbVar2 = (byte *)func_0x0001c632(*(undefined *)0x5897,*(undefined *)0x5896);
  bVar1 = *pbVar2;
  if (bVar1 == 0x16) {
    uVar3 = 0x2abd;
LAB_1040_09ab:
    local_4 = FUN_1040_0790(uVar3);
  }
  else {
    if (bVar1 < 0x17) {
      if (bVar1 == 0x10) {
      ...
      if (bVar1 == 0x19) {
        ...
        func_0x00019a80(*(undefined2 *)(iVar4 * 2 + 0x1f4e));
        func_0x000198ea(10);
LAB_1040_0968:
        func_0x0001fc9a();
        return 1;
...
int FUN_1040_0a1a(int param_1)

{
  char *pcVar1;
  undefined2 unaff_DS;
  
  pcVar1 = (char *)func_0x0001c632(*(undefined *)0x5897,*(undefined *)0x5896);
...
void __cdecl16near FUN_1040_0a60(void)

{
  ...
  if (*(char *)0x5895 != '\0') {
    iVar1 = func_0x0001a2c2(0xff,0);
    if (iVar1 == 0x69) {
      func_0x00019a80(0x2b1d);
      func_0x0001b2a2();
      func_0x0001acd8();
    }
  }
...
void __cdecl16near FUN_1040_0a84(void)

{
  ...
  do {
    bVar2 = false;
    local_a = 1;
    local_4 = FUN_1040_0a1a(local_4);
    iVar4 = func_0x0001bc2c();
    if (iVar4 == 1) {
      func_0x000198ea(10);
      func_0x0001ce5a();
      uVar5 = 0x2b2a;
LAB_1040_0aba:
      ...
      if ((bVar3 < 0x30) || (0x39 < bVar3)) {
        uVar8 = 0x1003;
        local_a = func_0x0001b3a8(bVar3);
      }
      else {
        uVar8 = 0x100f;
        local_a = func_0x0001c2b0(bVar3);
      }
    }
    if ((*(byte *)0x587c & 0xfc) != 0x20) {
      *(undefined *)0x5955 = 0;
    ...
    if (*(char *)0x5893 == '\0') {
      if (local_a != 0) {
        func_0x0001d1ac(2,uVar8);
        pbVar6 = (byte *)func_0x0001c632(*(undefined *)0x5897,*(undefined *)0x5896);
        bVar3 = *pbVar6;
        uVar7 = (uint)bVar3;
        if ((bVar3 & 0xfe) == 0x6a) {
          FUN_1040_1be8();
          ...
          func_0x00019a80(0x2b6b);
          if (*(char *)0x58cc == '\0') {
            func_0x00019a80(0x2b7e);
            func_0x00019a80(0x2ba1);
            pcVar1 = (char *)0x5897;
            *pcVar1 = *pcVar1 + '\x01';
          }
          else {
            func_0x00019a80(0x2b6e);
          }
        }
        FUN_1040_0a60();
        func_0x0001ad18();
        if ((uVar7 == 1) &&
          ...
          func_0x00019a80(0x2bb3);
          func_0x0001b752(*(undefined *)0x5897,*(undefined *)0x5896);
          FUN_1040_109e();
        }
...
void __cdecl16near FUN_1040_0d22(void)
...
int __cdecl16near FUN_1040_0d8c(void)
...
undefined FUN_1040_0e4e(int param_1)

{
  ...
  if ((((param_1 < 4) || ((0x5f < param_1 && (param_1 < 0x70)))) ||
    ...
    iVar1 = func_0x0001a2c2(0x40,0);
    if (iVar1 < 0x10) {
      if (0x7f < *(byte *)0x5895) {
        iVar1 = FUN_1040_0e04(0x2bf6);
        return *(undefined *)(iVar1 + 0x2bda);
      }
      if ((param_1 == 1) && (iVar1 = func_0x0001a2c2(7,0), iVar1 == 7)) {
        return 0xec;
      }
      iVar1 = FUN_1040_0e04(0x2bf0);
    ...
    if (((param_1 != 0xc) && (param_1 != 0xd)) &&
      ...
      if (*(byte *)0x5895 < 0x80) {
        iVar1 = FUN_1040_0e04(0x2bdc);
        return *(undefined *)(iVar1 + 0x2bc0);
      }
      iVar1 = FUN_1040_0e04(0x2be8);
...
void __cdecl16near FUN_1040_0f4e(void)
...
void __cdecl16near FUN_1040_0fc4(void)

{
  ...
  do {
    ...
    puVar4 = (undefined *)func_0x0001c632(uVar2,uVar1);
    cVar3 = FUN_1040_0e4e(*puVar4);
    if ((cVar3 != '\0') &&
       ((cVar3 != ',' || (pbVar5 = (byte *)func_0x0001c632(uVar2,uVar1), (*pbVar5 & 0xf0) != 0x60)))
       ) break;
    local_6 = local_6 + 1;
  } while (local_6 < 0x80);
  if (local_6 != 0x80) {
    iVar6 = func_0x0001bb14();
    func_0x0001bca4(iVar6,0,*(undefined *)0x5895,uVar2,uVar1,cVar3,cVar3);
    if (cVar3 == ',') {
...
undefined2 FUN_1040_105c(int param_1)
...
void __cdecl16near FUN_1040_109e(void)
  ...
  if ((*(byte *)0x587c & 0xf8) == 0x20) {
    ...
    if (uVar3 < *(byte *)0x5c5f) {
      ...
      *pcVar1 = *pcVar1 - local_4;
      ...
      func_0x00019a80(0x6ada);
      uVar3 = (uint)*(byte *)0x5c61;
      if ((uVar3 == 0) && (*(char *)0x57b0 == '\0')) {
        *(undefined *)0x587c = 0;
        func_0x0001ab30();
        func_0x0001db40();
        func_0x0001c5de(0x1e78,0x28,0x96,0x294);
        func_0x00019a80(0x6af6);
        while( true ) {
          iVar4 = func_0x0001bc2c();
          if (iVar4 == -1) break;
          func_0x0001b752(*(undefined *)0x5897,*(undefined *)0x5896);
        ...
        func_0x00019a80(0x6ae6);
        if ((int)uVar3 < 1) {
          pcVar1 = (char *)0x57b0;
          *pcVar1 = *pcVar1 + -1;
          cVar2 = func_0x0001a2c2(1,0);
          cVar2 = cVar2 + '\x14';
        }
        else {
...
void FUN_1040_1168(int param_1,int param_2,int param_3)
...
void FUN_1040_1248(int param_1)
...
undefined2 FUN_1040_131a(int param_1)

{
  ...
  if (((local_6 == 1) && (local_8 == 0)) || ((local_6 == 0 && (local_8 == 1)))) {
    FUN_1040_1248(param_1);
LAB_1040_139c:
    uVar3 = 1;
  }
  else {
    if ((bVar1 == 0x88) || (bVar1 == 0xdc)) {
      if ((local_6 < 4) && ((local_8 < 4 && (iVar4 = func_0x0001a2c2(7,0), iVar4 == 0)))) {
        func_0x0001db40();
        func_0x0001c5de(100,5,300,0x514);
      ...
      func_0x00019a80(0x6b1e);
      FUN_1040_1168(local_8,local_6,param_1);
      goto LAB_1040_139c;
    }
    uVar3 = 0;
  }
...
undefined2 FUN_1040_1482(undefined2 param_1,undefined2 param_2,int param_3)

{
  ...
  puVar1 = (undefined *)func_0x0001c632(param_1,param_2,*(undefined *)(param_3 * 8 + 0x5c5a));
  iVar2 = func_0x0001ae7c(*puVar1);
  if ((iVar2 != 0) && (iVar2 = func_0x0001b932(*(undefined *)0x5895,param_1,param_2), iVar2 == 0)) {
    return 1;
  }
  return 0;
}
...
undefined2 FUN_1040_14c8(uint param_1,uint param_2)
...
undefined FUN_1040_14ea(int param_1)
...
void FUN_1040_1578(int param_1,int param_2,int param_3)

{
  ...
  pbVar4 = (byte *)func_0x0001c632(iVar7,iVar3);
  if ((bVar2 & 0xfc) == 0x2c) {
  ...
  *(undefined *)(param_3 + 0x5c5d) = local_a;
  pbVar1 = (byte *)0x24e6;
  *pbVar1 = *pbVar1 | 2;
  pcVar6 = (char *)func_0x0001c632(iVar7,iVar3);
  if (*pcVar6 == -0x24) {
...
void FUN_1040_16fc(int param_1)

{
  ...
  while( true ) {
    ...
    if (iVar3 == 0) {
      iVar6 = FUN_1040_1482(uVar2 - 1,uVar1,param_1);
      if (iVar6 == 0) {
        return;
      }
      uVar4 = 0;
    ...
    if (iVar3 == 3) {
      iVar6 = FUN_1040_1482(uVar2,uVar1 - 1,param_1);
      if (iVar6 == 0) {
        return;
      }
      uVar4 = 0xffff;
...
LAB_1040_17ba:
  uVar5 = 0;
LAB_1040_1775:
  FUN_1040_1578(uVar5,uVar4,param_1);
  return;
}



void FUN_1040_17d4(undefined2 param_1,int param_2)

{
  ...
  iVar4 = func_0x0001a2c2(1,0);
  if (iVar4 == 1) {
    if (local_4 != 0) {
      iVar4 = FUN_1040_1482(uVar3,uVar2 + local_4,param_2);
      if ((iVar4 != 0) && (iVar4 = FUN_1040_14c8(uVar3,uVar2 + local_4), iVar4 != 0))
      goto LAB_1040_18e2;
    }
    if (local_6 == 0) {
LAB_1040_197d:
      FUN_1040_16fc(param_2);
      return;
    }
    iVar4 = FUN_1040_1482(uVar3 + local_6,uVar2,param_2);
    if ((iVar4 == 0) || (iVar4 = FUN_1040_14c8(uVar3 + local_6,uVar2), iVar4 == 0))
    goto LAB_1040_197d;
  }
  else {
    if (local_6 == 0) {
...
LAB_1040_18e2:
  ...
  local_4 = 0;
LAB_1040_192a:
  FUN_1040_1578(local_6,local_4,param_2);
  return;
}



void FUN_1040_198c(int param_1)

{
  ...
  if ((bVar3 & 0xfc) == 0xec) {
    ...
    *pbVar1 = *pbVar1 ^ 1;
    ...
    iVar5 = func_0x0001a2c2(1,0);
    if (iVar5 == 0) {
      FUN_1040_16fc(param_1);
      return;
    }
  }
  else if (bVar3 == 0xfc) {
    iVar5 = FUN_1040_14ea(param_1);
    if ((iVar5 != 0) &&
  ...
  uVar6 = 1;
LAB_1040_1a54:
  FUN_1040_17d4(uVar6,param_1);
  return;
}



int __cdecl16near FUN_1040_1a60(void)
...
LAB_1040_1a74:
    ...
    do {
      iVar4 = FUN_1040_105c(*puVar5);
      if (iVar4 != 0) {
        iVar4 = FUN_1040_131a(iVar3);
...
void __cdecl16near FUN_1040_1b3e(void)

{
  ...
  func_0x00019a80(0x6b2c);
  func_0x0001bc2c();
  iVar3 = (uint)*(byte *)(*(int *)0x5876 * 0x20 + 0x55b4) * 3 + -99;
  func_0x00019c6e(0x20,2);
  func_0x00019a80(0x6b4a);
  do {
    cVar2 = func_0x0001a89c();
    if (cVar2 == 'Y') break;
  } while (cVar2 != 'N');
  func_0x000198ea(cVar2);
  func_0x000198ea(10);
  if (cVar2 == 'Y') {
    piVar1 = (int *)0x57aa;
    *piVar1 = *piVar1 + iVar3;
  ...
  func_0x0001bca4(uVar4,0,0,*(undefined *)0x5897,*(undefined *)0x5896,0,0xe4);
  func_0x0001e380(uVar4);
  return;
}



void __cdecl16near FUN_1040_1be8(void)
    ...
    if (*(char *)0x585b != '\0') {
      ...
      do {
        if ((*pcVar3 != 'D') && (*pcVar3 != 'S')) {
          func_0x00019a80(local_c);
          func_0x00019a80(0x6b8c);
          iVar1 = 3;
          do {
            func_0x0001bd16(5);
            func_0x000198ea(0x2e);
            iVar1 = iVar1 + -1;
          } while (iVar1 != 0);
          func_0x00019a80(0x6b9c);
