...
int __cdecl16near sjog_141b_0000(void)
...
void sjog_141b_002a(undefined2 param_1,undefined2 param_2,int param_3)
...
undefined2 sjog_141b_006c(int param_1)

{
  char cVar1;
  undefined2 unaff_DS;
  
  ultima_1000_1850(0x84e6);
  while (((cVar1 = ultima_1000_266c(), cVar1 != ' ' && (cVar1 != '\x03')) && (cVar1 != '\x04'))) {
    if ((cVar1 == '\x02') || (cVar1 == '\x01')) break;
  }
  if (cVar1 == '\x01') {
    ultima_1000_1850(0x8508);
    param_1 = param_1 + 3;
  }
  else {
    if (cVar1 != '\x02') {
      if (cVar1 != '\x03') {
        ...
        ultima_1000_1850(0x84ec);
        return 0;
      }
      ultima_1000_1850(0x84f2);
      goto LAB_141b_00d2;
    }
    ultima_1000_1850(0x8500);
    param_1 = param_1 + 1;
  }
  param_1 = param_1 % 4;
LAB_141b_00d2:
  sjog_141b_002a(*(undefined *)0x5897,*(undefined *)0x5896,param_1);
  return 1;
}



void sjog_141b_012a(int param_1)

{
  ...
  ultima_1000_1850(0x85f4);
  return;
}



void sjog_141b_01f2(int param_1,int param_2)

{
  ...
  if (iVar3 == 0) {
    ...
    if (iVar3 == 0) {
      ultima_1000_1850(0x863a);
      uVar2 = 0xf;
    }
    else {
      ultima_1000_1850(0x8642);
      uVar2 = 2;
    }
    *(undefined *)(param_2 * 8 + 0x5c5b) = uVar2;
    *(undefined *)(param_2 * 8 + 0x5c5a) = uVar2;
    uVar2 = ultima_1000_2092(3,1);
    ...
    *pbVar1 = *pbVar1 | 2;
    ...
    ultima_1000_3a74(param_2,0,0,0,0,0,0);
    iVar3 = ultima_1000_2092(0x1f,0);
    if (iVar3 == 0x13) {
      ultima_1000_1850(0x8606);
      ultima_1000_223c(500,3000,0x28);
      *(undefined *)(param_1 * 0x20 + 0x55b3) = 0x50;
      *(undefined *)0xa9fa = 1;
    }
    else {
      uVar4 = ultima_1000_2092(3,0,0);
      iVar3 = ultima_1000_2092(uVar4);
      if (iVar3 == 0) {
        uVar4 = 0x8610;
      }
      else if (iVar3 == 1) {
...
void sjog_141b_02ea(int param_1,int param_2)
...
undefined2 sjog_141b_03a8(uint param_1,uint param_2,uint param_3)

{
  ...
  do {
    ...
    while (iVar5 = iVar5 + -1, -1 < iVar5) {
      iVar3 = ultima_1000_368e(param_1,param_2,param_3);
  ...
  ultima_1000_3a74(uVar4,uVar2,param_1,param_2,param_3,0x19,0x19);
  ultima_1000_1850(0x8680);
  pbVar1 = (byte *)0x24e6;
  *pbVar1 = *pbVar1 | 2;
  return 1;
}
...
undefined2 sjog_141b_045a(uint param_1,uint param_2)

{
  ...
  *pcVar1 = *pcVar1 + (char)iVar5;
  ...
  ultima_1000_1a3e(0x20,uVar4,iVar5);
  ultima_1000_1850(0x86be);
  ultima_1000_1850(*local_a);
  ultima_1000_1850(0x86ca);
  return 1;
}



void sjog_141b_0514(uint param_1,uint param_2)
...
LAB_141b_05a6:
      ...
      if (bVar3) {
        uVar5 = ultima_1000_38e4();
        uVar2 = *(undefined *)(iVar6 + 0x3e78);
        ultima_1000_3a74(uVar5,*(undefined *)(iVar6 + 0x3eea),*(undefined *)(iVar6 + 0x3fce),
                        *(undefined *)(iVar6 + 0x40b2),*(undefined *)(iVar6 + 0x4040),uVar2,uVar2);
        pbVar1 = (byte *)0x24e6;
        *pbVar1 = *pbVar1 | 2;
        sjog_141b_012a(uVar2);
      }
      else {
        ultima_1000_1850(0x86cc);
      }
      return;
    }
  }
  if (((((iVar6 != 0xd) || (*(char *)0x57ac != '\0')) ||
       (iVar4 = ultima_1000_368e(*(undefined *)0x5895,param_1,param_2), iVar4 != 0)) &&
...
void __cdecl16near sjog_141b_0646(void)

{
  ...
  if ((*(char *)0x58a7 == '\0') && (*(char *)0x58a6 == '\0')) {
    ...
    iVar8 = sjog_141b_006c(*(undefined *)0x6603);
    if (iVar8 == 0) {
      return;
    }
    uVar10 = *(uint *)0x5876;
    ...
    if (bVar4 == 0x70) {
      ...
      if (0xb0 < bVar4) {
        if (bVar4 == 0xc0) {
          ...
          ultima_1000_1850(0x88c8);
          ultima_1000_1850(0x88ea);
...
void __cdecl16near sjog_141b_095c(void)

{
  ...
  pbVar5 = (byte *)ultima_1000_4402(uVar4,uVar3);
  uVar6 = (uint)*pbVar5;
  pbVar5 = (byte *)0x5c64;
  ...
  if (iVar7 < 0x20) {
    ultima_1000_1850(0x892c);
    sjog_141b_02ea(iVar2,iVar7);
    return;
  }
  iVar7 = ultima_1000_3702(*(undefined *)0x5895,uVar4,uVar3);
  if (iVar7 == 0x1f) {
    ultima_1000_1850(0x893e);
    sjog_141b_01f2(iVar2,*(undefined2 *)0x5876);
    return;
  }
  if (uVar6 == 0xa5) {
    uVar8 = 0x8996;
...
LAB_141b_0a83:
  ...
  ultima_1000_1850(0x8a38);
  if (uVar6 == 0x4e) {
    ultima_1000_1850(0x8a48);
    if (*(byte *)0x5895 < 0x80) {
      puVar9 = (undefined *)ultima_1000_4402(uVar4,uVar3);
      *puVar9 = 0xb9;
    }
    else {
      puVar9 = (undefined *)ultima_1000_4402(uVar4,uVar3);
  ...
  else if (((uVar6 == 0xdc) || (iVar2 = sjog_141b_03a8(*(undefined *)0x5895,uVar4,uVar3), iVar2 == 0)
           ) && (iVar2 = sjog_141b_045a(uVar4,uVar3), iVar2 == 0)) {
    sjog_141b_0514(uVar4,uVar3);
  }
  return;
}
...
void sjog_141b_0baa(int param_1)

{
  ...
  if (iVar5 != -1) {
    ...
    if (bVar3 < 0x80) {
      ...
      uVar7 = ultima_1000_2092(0x1e,1);
      if ((((bVar3 & 0x7f) - (uint)bVar4) + 0x1e >> 1 & 0xff) < uVar7) {
        ultima_1000_1850(0x8a64);
...
void __cdecl16near sjog_141b_0c3e(void)

{
  ...
  ultima_1000_1850(0x8a7a);
  iVar4 = ultima_1000_4988();
  if (iVar4 == -1) {
    return;
  }
...
void __cdecl16near sjog_141b_0d4a(void)

{
  ...
  if (*(char *)0x57ac == '\0') {
    ...
    pbVar8 = (byte *)ultima_1000_4402(uVar7,uVar6);
    bVar3 = *pbVar8;
    if (bVar3 < 0x99) {
      if (0x96 < bVar3) {
        uVar4 = 0x8af2;
LAB_141b_0df2:
      ...
      if ((0x83 < bVar3) && (bVar3 < 0x86)) {
        if ((*(byte *)0x5893 < 0x80) &&
           (iVar5 = ultima_1000_368e(*(undefined *)0x5895,uVar7,uVar6), iVar5 == 0)) {
          uVar4 = 0x8afe;
        }
        else {
          ...
          if (*(byte *)0x5893 < 0x7f) {
            ...
            puVar12 = (undefined *)ultima_1000_4402(uVar7,uVar6);
            *puVar12 = 0x44;
            pbVar2 = (byte *)0x24e6;
            *pbVar2 = *pbVar2 | 2;
            uVar4 = 0x8b48;
      ...
      pcVar10 = (char *)ultima_1000_4402(uVar7,uVar6);
      *pcVar10 = bVar3 - 1;
      pbVar2 = (byte *)0x24e6;
      *pbVar2 = *pbVar2 | 2;
      uVar4 = 0x8ae6;
    ...
    if (iVar5 < 0x20) {
      sjog_141b_0baa(iVar5,*(undefined *)0x5895,uVar7,uVar6);
      return;
    }
    uVar4 = 0x8b52;
  }
...
void sjog_141b_0f88(int *param_1,int param_2,undefined2 param_3,undefined2 param_4,undefined2 param_5
...

{
  ...
  param_6 = ultima_1000_2092(param_2,1);
LAB_141b_0fc9:
  iVar2 = sjog_141b_0000();
  if (iVar2 != 0) {
    ultima_1000_3a74(iVar2,param_6,param_3,param_4,param_5,param_7,param_7);
    if (*(byte *)0x5893 < 0x80) {
    ...
    *pbVar1 = *pbVar1 | 2;
    ultima_1000_5910();
    if (*param_1 == 0) {
      ultima_1000_1850(0x8b5c);
      *param_1 = 1;
    }
    sjog_141b_012a(param_7);
  }
  return;
}
...
void sjog_141b_1040(undefined2 param_1,undefined2 param_2,undefined2 param_3,undefined2 param_4,
                  uint param_5)

{
  ...
  while (iVar3 = iVar2, iVar2 = iVar3 + -1, -1 < iVar2) {
    if (*(byte *)(iVar3 + 0x412b) <= param_5) {
      uVar1 = ultima_1000_2092(0x1e,1);
      if (*(byte *)(iVar3 + 0x412b) <= uVar1) {
        if (*(char *)(iVar3 + 0x4133) == '\x01') {
          uVar4 = 1;
        }
        else {
          uVar4 = ultima_1000_2092(*(undefined *)(iVar3 + 0x4133),1);
        }
        sjog_141b_0f88(param_1,param_5,param_2,param_3,param_4,uVar4,*(undefined *)(iVar3 + 0x4123));
      }
    }
  }
  return;
...
void sjog_141b_10b8(undefined2 param_1,undefined2 param_2,undefined2 param_3,undefined2 param_4,
                  uint param_5)

{
  ...
  while (iVar1 = local_4 + -1, -1 < local_4) {
    iVar2 = ultima_1000_2092(0x2f,0);
    local_4 = iVar1;
    if (*(byte *)(iVar2 + 0x416c) <= param_5) {
      uVar3 = ultima_1000_2092(0x1e,1);
      if (*(byte *)(iVar2 + 0x416c) <= uVar3) {
        sjog_141b_0f88(param_1,param_5,param_2,param_3,param_4,iVar2,*(undefined *)(iVar2 + 0x413c));
      }
    }
  }
  return;
...
void sjog_141b_112c(uint param_1,uint param_2,uint param_3)

{
  ...
  if (local_6 == 0x20) {
    ...
    uVar6 = ultima_1000_4988();
    if (uVar6 == 0xffff) {
      return;
    }
    local_8 = *(byte *)(local_6 * 8 + 0x5c5f);
    ultima_1000_3a74(local_6,0,0,0,0,0,0);
    pbVar1 = (byte *)0x24e6;
    *pbVar1 = *pbVar1 | 2;
    ...
    if (0x7f < local_8) {
      ...
      ultima_1000_1850(0x8b7e);
      ultima_1000_2fd0(uVar6);
    ...
    bVar3 = local_8;
    sjog_141b_1040(&local_a,param_1,param_2,param_3,local_8);
    sjog_141b_10b8(&local_a,param_1,param_2,param_3,bVar3);
    if (local_a != 0) {
      return;
    }
    uVar5 = 0x8b88;
...
void __cdecl16near sjog_141b_12d4(void)
...
void __cdecl16near sjog_141b_1374(void)

{
  ...
  pbVar4 = (byte *)ultima_1000_4402(iVar3,iVar2);
  bVar1 = *pbVar4;
  if (bVar1 == 0xaf) {
    uVar5 = 0x8bbe;
    goto LAB_141b_13ed;
  ...
  if (bVar1 < 0xb0) {
    if (bVar1 < 0x97) {
LAB_141b_1444:
      sjog_141b_112c(*(undefined *)0x5895,iVar3,iVar2);
      return;
    }
    if (0x98 < bVar1) {
      if (bVar1 == 0x99) {
...
LAB_141b_1400:
      ...
      *(undefined *)0x5951 = local_8;
      puVar6 = (undefined *)ultima_1000_4402(iVar3,iVar2);
      *puVar6 = 0x44;
      *(undefined *)0x24e6 = 1;
      uVar5 = 0x8be0;
      goto LAB_141b_13ed;
...
void sjog_141b_1458(int param_1,uint param_2,int param_3)
...
LAB_141b_1485:
      ultima_1000_1850(0x8d92);
      return;
    }
    if ((param_2 == 0x1b) || (param_2 == 0x1d)) {
      ultima_1000_3ef0(99,5,param_2 + 0x57c0);
    }
    else {
  ...
  if (param_3 == 0x19) {
    ultima_1000_1850(0x8c4e);
    *(undefined *)(param_2 + 0x5840) = 0xff;
    goto LAB_141b_177a;
  }
  if (param_3 < 0x1a) {
    if (param_3 == 0xd) {
      ultima_1000_1a3e(0x20,1,param_2);
      ultima_1000_1850(0x8c8a);
      if (param_2 == 1) {
        uVar3 = 0x8c92;
      }
      else {
      ...
      ultima_1000_1850(uVar3);
      ultima_1000_3ef0(99,param_2,0x57ae);
    }
    else if (param_3 == 0xe) {
      ultima_1000_1850(0x8c76);
      ...
      *pbVar2 = *pbVar2 | 0x80;
      ...
      ultima_1000_1a3e(0x20,1,param_2);
      ultima_1000_1850(0x8c6e);
      ultima_1000_3f14(9999,param_2,0x57a8);
    }
    goto LAB_141b_177a;
  }
  if (param_3 == 0x1b) {
    ultima_1000_1850(0x8c5c);
    pcVar1 = (char *)0x57b0;
    *pcVar1 = *pcVar1 + '\x01';
    if (*(char *)0x57b0 == 'd') {
      *(undefined *)0x57b0 = 99;
...
LAB_141b_177a:
  if (param_1 < 0x20) {
    ultima_1000_3a74(param_1,0,0,0,0,0,0);
  }
  pbVar2 = (byte *)0x24e6;
  *pbVar2 = *pbVar2 | 2;
  *(undefined *)0xa9fa = 1;
...
void __cdecl16near sjog_141b_179e(void)

{
  ...
  if ((bVar2 & 0xf0) == 0x40) {
    ...
    if ((bVar2 & 0xf0) == 0x70) {
      ...
      *pbVar1 = *pbVar1 & 8;
      ultima_1000_1850(0x8dbc);
      iVar5 = 0;
      do {
        uVar4 = ultima_1000_2092((uint)*(byte *)0x5895 * 4 + 4,1);
        if (*(byte *)(iVar5 + 0x41bc) <= uVar4) {
          if (iVar5 == 5) {
            uVar3 = ultima_1000_2092(7,0);
            uVar6 = 3;
          }
          else if (iVar5 == 6) {
            uVar3 = ultima_1000_2092(7,0);
            ...
            uVar3 = ultima_1000_2092(uVar4,1);
            uVar6 = *(undefined *)(iVar5 + 0x41cc);
          }
          sjog_141b_1458(0x20,uVar3,uVar6);
        }
        iVar5 = iVar5 + 1;
      } while (iVar5 < 7);
      return;
...
void __cdecl16near sjog_141b_18ce(void)

{
  ...
  if (local_6 < 0x20) {
    sjog_141b_1458(local_6,*(undefined *)(local_6 * 8 + 0x5c5f),local_8);
    return;
  }
  pbVar11 = (byte *)ultima_1000_4402(uVar8,uVar7);
  bVar4 = *pbVar11;
  if (bVar4 == 0x9a) {
    if (iVar3 != 1) {
      uVar10 = 0x8e10;
    ...
    puVar9 = (undefined *)ultima_1000_4402(uVar8,uVar7);
    *puVar9 = 0x95;
    pbVar2 = (byte *)0x24e6;
    *pbVar2 = *pbVar2 | 2;
    uVar10 = 0x8e04;
    ...
    if (0x9a < bVar4) {
      ...
      ultima_1000_3f14(9999,1,0x57a8);
      goto LAB_141b_1a58;
    }
    if (bVar4 != 0x2d) {
LAB_141b_1b28:
...
int sjog_141b_1b34(undefined2 param_1)

{
  ...
  for (uVar2 = 0; uVar2 < *(byte *)0x585b; uVar2 = uVar2 + 1) {
    iVar1 = ultima_1000_6e60(param_1,uVar2);
    if (iVar1 != 0) {
      iVar3 = iVar3 + 1;
    }
  }
...
void __cdecl16near sjog_141b_1b6c(void)
...
undefined2 sjog_141b_1bb2(uint param_1,int param_2)
...
undefined2 sjog_141b_1c56(int param_1,int param_2)
...
LAB_141b_1c9c:
  ...
  if ((((local_a < 0xb) && (local_c < 0xb)) && (-1 < local_a)) && (-1 < local_c)) {
    ...
    uVar2 = sjog_141b_1bb2(param_1,param_2);
  }
  return uVar2;
}
...
undefined2 __cdecl16near sjog_141b_1d6a(void)

{
  ...
  ultima_1000_1850(0x8ede);
  pcVar2 = (char *)ultima_1000_4402(*(undefined *)0x5897,*(undefined *)0x5896);
  cVar8 = *pcVar2;
  if ((((*(byte *)0x58a1 & 2) != 0) && (cVar8 == -0x38)) && (*(char *)0xbb16 != '\0')) {
    ultima_1000_1850(0x8ee6);
    do {
      iVar3 = ultima_1000_266c();
      if (iVar3 != 3) {
  ...
  if (cVar8 == -0x38) {
    ultima_1000_1850(0x8eec);
    uVar1 = *(undefined *)0x589e;
    uVar4 = 5;
  }
  else {
    if (((cVar8 != -0x7a) || ((*(byte *)0x58a1 & 0x80) == 0)) && (cVar8 != -0x37)) {
      iVar3 = ultima_1000_35ec();
      if (iVar3 != 0) {
        iVar3 = (uint)*(byte *)0x5896 + *(int *)0x5876;
        iVar5 = (uint)*(byte *)0x5897 + *(int *)0x5878;
        pcVar2 = (char *)ultima_1000_4402(iVar5,iVar3);
        if ((*pcVar2 != 'L') || (iVar6 = ultima_1000_3702(0,iVar5,iVar3), iVar6 != 0)) {
          ultima_1000_1850(0x8efa);
          return 0;
        }
    ...
    ultima_1000_1850(0x8ef2);
    uVar1 = *(undefined *)0x589e;
    uVar4 = 6;
  }
  uVar4 = sjog_141b_1bb2(uVar4,uVar1);
  return uVar4;
}



void __cdecl16near sjog_141b_1ea4(void)

{
  ...
  if ((((*(char *)(iVar1 + -0x45ea) != '\0') && ((*(byte *)(iVar1 + -0x45ea) & 0x20) == 0)) &&
    ...
    *(undefined *)0x58a0 = 0x4d;
    ultima_1000_16ba(10,iVar1 + -0x45ec);
    func_0x0001ffca(*(undefined *)0x589e);
    ultima_1000_1850(0x8f02);
    ultima_1000_43ae(0x28,1,2000,0x4b0);
    *(undefined *)0x587b = 0xff;
    ultima_1000_2900();
...
undefined2 sjog_141b_1f26(int param_1,undefined2 param_2)

{
  undefined2 uVar1;
  
  ultima_1000_1850(param_2);
  if (param_1 == 1) {
    uVar1 = 0x8f12;
  }
  else if (param_1 == 2) {
...
LAB_141b_1f4b:
  ultima_1000_16ba(10);
  ultima_1000_22c0(0x96,0xdc);
  ultima_1000_22c0(0x96,0x96);
  return 1;
}



int sjog_141b_1f7a(uint param_1)

{
  ...
  local_8 = 0;
  ultima_1000_1850(0x8f3a);
  iVar3 = 0;
  local_a = (byte *)0xba16;
  local_c = (byte *)0xba17;
  while (((bVar1 = *local_a, (bVar1 & 0x80) == 0 || (iVar2 = ultima_1000_5646(iVar3), iVar2 != 0)) ||
         (*local_c != param_1))) {
    local_a = local_a + 8;
    local_c = local_c + 8;
    iVar3 = iVar3 + 1;
...
void sjog_141b_203e(int param_1)
...
int sjog_141b_20d8(int param_1,uint param_2,uint param_3)
...
bool sjog_141b_2148(int param_1)
...
LAB_141b_21ae:
    ...
    iVar1 = sjog_141b_20d8(param_1,uVar3,uVar2);
    if (iVar1 != 0) {
      local_6 = local_6 + 1;
    }
    local_c = local_c + 1;
...
int __cdecl16near sjog_141b_21ce(void)
...
LAB_141b_222d:
  ...
  pbVar1 = pbVar2;
  *pbVar1 = *pbVar1 & 0xfe;
  ultima_1000_1850((uint)*pbVar3 * 0x20 + 0x55a8);
  ultima_1000_1850(0x8f56);
  ultima_1000_2192(2,1000,30000,1,0xc1c);
  ultima_1000_6e60(0x23,*pbVar3);
  ultima_1000_68ae(local_4);
  goto LAB_141b_222d;
}
