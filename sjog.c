...
undefined2 FUN_0000_03a8(uint param_1,uint param_2,uint param_3)

{
  ...
  do {
    ...
    while (iVar5 = iVar5 + -1, -1 < iVar5) {
      iVar3 = func_0x0000770e(param_1,param_2,param_3);
  ...
  func_0x00007af4(uVar4,uVar2,param_1,param_2,param_3,0x19,0x19);
...
undefined2 FUN_0000_045a(uint param_1,uint param_2)

{
  ...
  *pcVar1 = *pcVar1 + (char)iVar5;
  ...
  func_0x00005abe(0x20,uVar4,iVar5);
...
LAB_0000_05a6:
      ...
      if (bVar3) {
        ...
        func_0x00007af4(uVar5,*(undefined *)(iVar6 + 0x3eea),*(undefined *)(iVar6 + 0x3fce),
  ...
  if (((((iVar6 != 0xd) || (*(char *)0x57ac != '\0')) ||
       (iVar4 = func_0x0000770e(*(undefined *)0x5895,param_1,param_2), iVar4 != 0)) &&
...

{
  ...
  if ((*(char *)0x58a7 == '\0') && (*(char *)0x58a6 == '\0')) {
    ...
    iVar8 = FUN_0000_006c(*(undefined *)0x6603);
    if (iVar8 == 0) {
      return;
    }
    uVar10 = *(uint *)0x5876;
...

{
  ...
  pbVar5 = (byte *)func_0x00008482(uVar4,uVar3);
  uVar6 = (uint)*pbVar5;
  pbVar5 = (byte *)0x5c64;
  ...
  iVar7 = func_0x00007782(*(undefined *)0x5895,uVar4,uVar3);
  if (iVar7 == 0x1f) {
...
LAB_0000_0a83:
  ...
  if (uVar6 == 0x4e) {
    ...
    if (*(byte *)0x5895 < 0x80) {
      puVar9 = (undefined *)func_0x00008482(uVar4,uVar3);
      *puVar9 = 0xb9;
    }
    else {
      puVar9 = (undefined *)func_0x00008482(uVar4,uVar3);
  ...
  else if (((uVar6 == 0xdc) || (iVar2 = FUN_0000_03a8(*(undefined *)0x5895,uVar4,uVar3), iVar2 == 0)
           ) && (iVar2 = FUN_0000_045a(uVar4,uVar3), iVar2 == 0)) {
    FUN_0000_0514(uVar4,uVar3);
  }
  return;
}
...
LAB_0000_0df2:
      ...
      if ((0x83 < bVar3) && (bVar3 < 0x86)) {
        if ((*(byte *)0x5893 < 0x80) &&
           (iVar5 = func_0x0000770e(*(undefined *)0x5895,uVar7,uVar6), iVar5 == 0)) {
          uVar4 = 0x8afe;
        }
        else {
    ...
    if (iVar5 < 0x20) {
      FUN_0000_0baa(iVar5,*(undefined *)0x5895,uVar7,uVar6);
      return;
    }
    uVar4 = 0x8b52;
  }
...

{
  ...
  if (bVar1 < 0xb0) {
    if (bVar1 < 0x97) {
LAB_0000_1444:
      FUN_0000_112c(*(undefined *)0x5895,iVar3,iVar2);
      return;
    }
    if (0x98 < bVar1) {
      if (bVar1 == 0x99) {
...
LAB_0000_1485:
  ...
  if (param_3 < 0x1a) {
    if (param_3 == 0xd) {
      func_0x00005abe(0x20,1,param_2);
  ...
  if (param_3 == 0x1b) {
    ...
    *pcVar1 = *pcVar1 + '\x01';
    ...
    if (*(char *)0x5893 != '\x11') goto LAB_0000_177a;
    uVar3 = 0x16;
LAB_0000_14c2:
  ...
  if ((bVar2 & 0xf0) == 0x40) {
    ...
    if ((bVar2 & 0xf0) == 0x70) {
      ...
      *pbVar1 = *pbVar1 & 8;
      ...
      iVar5 = 0;
      do {
        uVar4 = func_0x00006112((uint)*(byte *)0x5895 * 4 + 4,1);
...
undefined2 FUN_0000_1bb2(uint param_1,int param_2)
...
undefined2 FUN_0000_1c56(int param_1,int param_2)

{
  ...
  if (param_1 == 1) {
    ...
    if (param_1 != 4) goto LAB_0000_1c9c;
    local_c = 1;
    uVar2 = 0x8ec0;
  }
...
LAB_0000_1c9c:
  ...
  if ((((local_a < 0xb) && (local_c < 0xb)) && (-1 < local_a)) && (-1 < local_c)) {
    iVar4 = (uint)bVar1 * 8;
    iVar3 = func_0x0000bdf6(local_c,local_a,*(undefined *)(iVar4 + 0x5c5a));
    if (iVar3 == 0) {
      ...
      *(undefined *)(iVar4 + 0x5c5d) = local_6;
      ...
      if ((*(byte *)0x58a1 & 0x82) != 0) {
        func_0x0000bf3a(local_c,local_a);
      }
      uVar2 = 1;
    }
  }
  else {
    uVar2 = FUN_0000_1bb2(param_1,param_2);
  }
  return uVar2;
}
...

{
  ...
  uVar4 = FUN_0000_1bb2(uVar4,uVar1);
  return uVar4;
}



void __cdecl16near FUN_0000_1ea4(void)

{
  ...
  if ((((*(char *)(iVar1 + -0x45ea) != '\0') && ((*(byte *)(iVar1 + -0x45ea) & 0x20) == 0)) &&
    ...
    *(undefined *)0x587b = 0xff;
    func_0x00006980();
    func_0x0000be02(-1 - (uint)*(byte *)0x589e);
    func_0x00009990();
  }
  return;
}
...
int FUN_0000_20d8(int param_1,uint param_2,uint param_3)

{
  ...
  {
    local_6 = func_0x0000bdf6(param_2,param_3,
